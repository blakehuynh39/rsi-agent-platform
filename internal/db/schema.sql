...
create index if not exists question_run_workflow_idx on question_run (workflow_id, updated_at desc);
create index if not exists question_run_trace_idx on question_run (trace_id, updated_at desc);
