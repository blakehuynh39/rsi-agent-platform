...
type HermesExecutionStatus struct {
	...
	LastObservedLedgerSeq        string          `json:"last_observed_ledger_seq,omitempty"`
	LastObservedEventType        string          `json:"last_observed_event_type,omitempty"`
	LastObservedEventStatus      string          `json:"last_observed_event_status,omitempty"`
	LastObservedPhase            string          `json:"last_observed_phase,omitempty"`
	LastObservedRecordedAt       string          `json:"last_observed_recorded_at,omitempty"`
	LastObservedAtUnix           float64         `json:"last_observed_at_unix,omitempty"`
	LastObservedInvocationID     string          `json:"last_observed_invocation_id,omitempty"`
	StatusFilePath               string          `json:"status_file_path,omitempty"`
	StatusFileMtimeUnix          float64         `json:"status_file_mtime_unix,omitempty"`
	StatusFileSizeBytes          int64           `json:"status_file_size_bytes,omitempty"`
