...
Collected incident reports and spike protection events for the story-api service.

## Claims

- On 2025-10-29, many story-api endpoints appeared to be working, but further investigation via Sentry was needed to identify the exact request causing issues. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2025-12-22T10:50:56Z. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2025-12-22T11:40:07Z. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2025-12-23T11:51:02Z. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2025-12-23T12:30:08Z. `claim:claim_1_5` `confidence:1.00`
...
- POST /hub/users/notifications failed with 500: Failed to list notifications on 2026-01-13. `claim:claim_1_6` `confidence:1.00`
...
- POST /api/v3/*any failed with 500: Internal Server Error on 2026-01-13. `claim:claim_1_7` `confidence:1.00`
...
- POST /api/v4/search failed with 500: Internal Server Error on 2026-01-13. `claim:claim_1_8` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2026-01-28T12:58:51Z. `claim:claim_1_9` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2026-01-28T13:30:11Z. `claim:claim_1_10` `confidence:1.00`
...
- POST /api/v4/assets/edges failed with 500: Internal Server Error on 2026-02-24. `claim:claim_1_11` `confidence:1.00`
...
- POST /api/v4/licenses/tokens failed with 500: Internal Server Error on 2026-02-24. `claim:claim_1_12` `confidence:1.00`
...
- POST /api/v4/transactions failed with 500: Internal Server Error on 2026-02-24. `claim:claim_1_13` `confidence:1.00`
...
- POST /api/v4/disputes failed with 500: Internal Server Error on 2026-02-24. `claim:claim_1_14` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error on 2026-02-24. `claim:claim_1_15` `confidence:1.00`
...
- Search failure: failed to perform search; all retries failed: failed to unmarshal response: unexpected end of JSON input on 2026-02-24. `claim:claim_1_16` `confidence:1.00`
...
- Search failure: failed to perform search; all retries failed: received status code 500 on 2026-02-24. `claim:claim_1_17` `confidence:1.00`
...
- Fatal PostgreSQL authentication failure for user "postgres" on 2026-02-25. `claim:claim_1_18` `confidence:1.00`
...
- Failed to create IP asset: null value in column "blacklisted" violates not-null constraint on 2026-02-26. `claim:claim_1_19` `confidence:1.00`
...
- Failed to create entity: null value in column "id" of relation "users" violates not-null constraint on 2026-02-26. `claim:claim_1_20` `confidence:1.00`
...
- POST /api/v4/collections failed with 500: Internal Server Error on 2026-03-01. `claim:claim_1_21` `confidence:1.00`
...
- ParseInt error: parsing "99999999999999999999999": value out of range on 2026-03-05. `claim:claim_1_22` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal server error on 2026-03-05. `claim:claim_1_23` `confidence:1.00`
...
- `source_revision_id`: `srcrev_38058dc9d56787c50303410c449b1e92`
