...
Alerts and errors from the story-api project observed via Slack channel C07K3J4JTH6 from December 2025 to March 2026. Includes spike protection activations/deactivations, 500 Internal Server Errors on multiple endpoints, database constraint violations, and an integer parsing error.

## Claims

- Initial investigation noted that many story-api endpoints appeared to be working, and further analysis in Sentry was required to identify the problematic request. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection for story-api spans was activated on 2025-12-22 at 10:50:56 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection for story-api spans was deactivated on 2025-12-22 at 11:40:07 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection for story-api spans was activated on 2025-12-23 at 11:51:02 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection for story-api spans was deactivated on 2025-12-23 at 12:30:08 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection for story-api spans was activated on 2026-01-28 at 12:58:51 UTC. `claim:claim_1_6` `confidence:1.00`
...
- Spike protection for story-api spans was deactivated on 2026-01-28 at 13:30:11 UTC. `claim:claim_1_7` `confidence:1.00`
...
- Multiple API endpoints experienced 500 Internal Server Errors. Observed endpoints include: POST /hub/users/notifications, POST /api/v3/*any, POST /api/v4/search, POST /api/v4/assets/edges, POST /api/v4/licenses/tokens, POST /api/v4/transactions, POST /api/v4/disputes, GET /api/v4/disputes/:disputeId, POST /api/v4/collections, and GET /api/v4/disputes/:disputeId again. `claim:claim_1_8` `confidence:1.00`
...
- Search functionality returned errors: 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input' and 'failed to perform search: all retries failed: received status code 500'. `claim:claim_1_9` `confidence:1.00`
...
- A fatal database authentication error occurred: 'FATAL #28P01 password authentication failed for user "postgres"'. `claim:claim_1_10` `confidence:1.00`
...
- A database constraint violation occurred when creating an IP asset: 'ERROR #23502 null value in column "blacklisted" of relation "ip_assets" violates not-null constraint'. `claim:claim_1_11` `confidence:1.00`
...
- A database constraint violation occurred when creating an entity: 'ERROR #23502 null value in column "id" of relation "users" violates not-null constraint'. `claim:claim_1_12` `confidence:1.00`
...
- An integer parsing error occurred: 'strconv.ParseInt: parsing "99999999999999999999999": value out of range'. `claim:claim_1_13` `confidence:1.00`
...
- Are the 500 errors on multiple endpoints related to a common underlying issue?
- Is there a root cause analysis for these incidents?
- What caused the database authentication failure and constraint violations?
...
- `source_revision_id`: `srcrev_1ef641f7daa58b0cde0418f6a097e3b5`
