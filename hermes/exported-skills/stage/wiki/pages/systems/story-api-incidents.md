...
Documented incidents and spike protection events for the story-api service.

## Claims

- Spike protection activated for story-api for spans on 2025-12-22 10:50:56 UTC `claim:claim_1_1` `confidence:1.00`
...
- Spike protection deactivated for story-api for spans on 2025-12-22 11:40:07 UTC `claim:claim_1_2` `confidence:1.00`
...
- Spike protection activated for story-api for spans on 2025-12-23 11:51:02 UTC `claim:claim_1_3` `confidence:1.00`
...
- Spike protection deactivated for story-api for spans on 2025-12-23 12:30:08 UTC `claim:claim_1_4` `confidence:1.00`
...
- Spike protection activated for story-api for spans on 2026-01-28 12:58:51 UTC `claim:claim_1_5` `confidence:1.00`
...
- Spike protection deactivated for story-api for spans on 2026-01-28 13:30:11 UTC `claim:claim_1_6` `confidence:1.00`
...
- Search error: failed to unmarshal response: unexpected end of JSON input `claim:claim_1_15` `confidence:1.00`
...
- Search error: all retries failed with status code 500 `claim:claim_1_16` `confidence:1.00`
...
- Database authentication error: FATAL #28P01 password authentication failed for user "postgres" `claim:claim_1_17` `confidence:1.00`
...
- Failed to create IP asset: null value in column "blacklisted" violates not-null constraint `claim:claim_1_18` `confidence:1.00`
...
- Failed to create entity: null value in column "id" violates not-null constraint in users table `claim:claim_1_19` `confidence:1.00`
...
- Value out of range error: parsing "99999999999999999999999" `claim:claim_1_21` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal server error (duplicate occurrence) `claim:claim_1_22` `confidence:1.00`
...
- `source_revision_id`: `srcrev_d004af91ca1513818a1da8d67c891d93`
