...
The aeneid testnet faucet system, including the GCP instance use1-aeneid-fuacet, its migration to AWS, and associated components.

## Claims

- The faucet server is the GCP instance 'use1-aeneid-fuacet' with IP 35.207.0.103. `claim:claim_1_1` `confidence:1.00`
...
- The backend validates frontend requests, records wallet addresses in a database, and batch sends testnet tokens. `claim:claim_1_3` `confidence:1.00`
...
- The faucet frontend is served at https://aeneid.faucet.story.foundation/. `claim:claim_1_4` `confidence:1.00`
...
- The faucet was developed by subteam S07ASS1JQNP. `claim:claim_1_5` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_dc87e72b13ffb646b259a7fc91c395d8` `chunk_id=srcchunk_3f7de3056380c3b0a128e380c3c3f79f` `native_locator=slack:C0547N89JUB:1770083249.859729:1770085370.453109` `source_timestamp=2026-02-03T02:22:50Z`
- A migration to AWS is planned, requiring the frontend to point to a domain instead of an IP. `claim:claim_1_6` `confidence:1.00`
...
- GCP access to story-aeneid project has been granted to user U0643B9PPC1. `claim:claim_1_7` `confidence:1.00`
...
- Is the server still actively used as of 2026-02?
- What are the specific AWS accounts and GCP projects involved in the migration?
- What is the status of domain setup for the faucet frontend?

## Sources

- `source_document_id`: `srcdoc_39d343ffa196af216bd4ea35c17da039`
- `source_revision_id`: `srcrev_62ae0c091205106a8afb5bed6ae87984`
