...
The Aeneid testnet faucet frontend at https://aeneid.faucet.story.foundation/ and backend hosted on GCP instance use1-aeneid-fuacet (IP 35.207.0.103). The service validates requests, stores wallet addresses, and batch sends testnet tokens. Currently being migrated from GCP to AWS.
...
- The faucet backend is queried by the frontend at http://35.207.0.103:23313/. `claim:claim_1_2` `confidence:1.00`
...
- The IP 35.207.0.103 belongs to the GCP instance use1-aeneid-fuacet. `claim:claim_1_3` `confidence:1.00`
...
- The backend validates the frontend request, adds the wallet address to a database table, and later batch sends testnet tokens. `claim:claim_1_4` `confidence:1.00`
...
- The faucet server is hosted in GCP project story-aeneid. `claim:claim_1_5` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_50b60006f4eeb38f39acd80cb65b8cff` `chunk_id=srcchunk_bf85328875d49cd44ea72f1a0ed48af2` `native_locator=slack:C0547N89JUB:1770083249.859729:1770971356.987109` `source_timestamp=2026-02-13T08:29:16Z`
...
- The team plans to migrate the faucet from GCP to AWS. `claim:claim_1_6` `confidence:1.00`
...
- To facilitate migration, the frontend should be updated to use a domain name rather than a hardcoded IP address. `claim:claim_1_7` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_15036f8cdcd7730d9bf3ef252d63cd08` `chunk_id=srcchunk_b8eb04c30ffaafd6bc68a3ae08061d6b` `native_locator=slack:C0547N89JUB:1770083249.859729:1770971534.533319` `source_timestamp=2026-02-13T08:32:14Z`
- Access to GCP (story-aeneid) and AWS (story-testnet) was granted to @U0643B9PPC1 for the migration. `claim:claim_1_8` `confidence:1.00`
  ...
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_2729f1cdf2797dbe69c29554151a9905` `chunk_id=srcchunk_2a3b7fa2db993f52fdcf4a3068729d22` `native_locator=slack:C0547N89JUB:1770083249.859729:1771024705.562899` `source_timestamp=2026-02-13T23:18:25Z`
- The faucet was developed by the subteam S07ASS1JQNP. `claim:claim_1_9` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_dc87e72b13ffb646b259a7fc91c395d8` `chunk_id=srcchunk_3f7de3056380c3b0a128e380c3c3f79f` `native_locator=slack:C0547N89JUB:1770083249.859729:1770085370.453109` `source_timestamp=2026-02-03T02:22:50Z`

## Open Questions

- Has a domain been assigned for the backend to replace the hardcoded IP?
...
- `source_revision_id`: `srcrev_b5c4f01d7d0c6303701c151ce73baf80`
