...
GCP compute instance hosting the backend for the Aeneid faucet at aeneid.faucet.story.foundation.

## Claims

- The server instance is `use1-aeneid-fuacet` in GCP project `story-aeneid`, zone `us-east1-c`. `claim:claim_1_1` `confidence:1.00`
...
- The server's IP address is `35.207.0.103`. `claim:claim_1_2` `confidence:1.00`
...
- The faucet frontend at `https://aeneid.faucet.story.foundation/` queries this server on port 23313. `claim:claim_1_3` `confidence:1.00`
...
- The server is currently in use and being migrated to AWS. `claim:claim_1_5` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_50b60006f4eeb38f39acd80cb65b8cff` `chunk_id=srcchunk_bf85328875d49cd44ea72f1a0ed48af2` `native_locator=slack:C0547N89JUB:1770083249.859729:1770971356.987109` `source_timestamp=2026-02-13T08:29:16Z`
