...
The Aeneid Faucet system provides testnet tokens via a web frontend hosted at aeneid.faucet.story.foundation, which queries a backend server on GCP (IP 35.207.0.103). The backend validates requests and stores wallet addresses in a database, then batches and sends tokens.

## Claims

- The faucet frontend is available at https://aeneid.faucet.story.foundation/. `claim:claim_1_1` `confidence:1.00`
...
- The backend server is the GCP instance 'use1-aeneid-fuacet' with IP 35.207.0.103. `claim:claim_1_3` `confidence:1.00`
...
- The backend validates frontend requests, adds wallet addresses to a database table, and then chronologically checks and batch sends testnet tokens. `claim:claim_1_4` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_43c0946f3f4587e464c535b2f02e284a` `chunk_id=srcchunk_42b6f69cb1c483b952a70161fab8aedb` `native_locator=slack:C0547N89JUB:1770083249.859729:1770969770.716529` `source_timestamp=2026-02-13T08:03:17Z`
- The backend server currently does not have a domain name attached; it is accessed by IP address. `claim:claim_1_5` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_43c0946f3f4587e464c535b2f02e284a` `chunk_id=srcchunk_42b6f69cb1c483b952a70161fab8aedb` `native_locator=slack:C0547N89JUB:1770083249.859729:1770969770.716529` `source_timestamp=2026-02-13T08:03:17Z`

## Open Questions

- Is the faucet server still in use? Confirmed by chunk srcchunk_bf85328875d49cd44ea72f1a0ed48af2.
- Who are the exact owners? Mentions: U04L0DD6B6F, U0643B9PPC1, U063MQ9ADCM, U07A7AUGL5V, U09M2SPUTSL, etc. We can set owners to those who provided info.
