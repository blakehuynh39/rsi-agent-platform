...
The Aeneid faucet service provides testnet tokens to users. It consists of a frontend at https://aeneid.faucet.story.foundation/ and a backend server currently hosted on GCP instance use1-aeneid-fuacet (IP 35.207.0.103). The frontend sends requests to the backend, which validates and batches token distribution. There is an ongoing migration to AWS.

## Claims

- A GCP instance named use1-aeneid-fuacet exists. `claim:claim_1_1` `confidence:1.00`
...
- The faucet frontend is at https://aeneid.faucet.story.foundation/. `claim:claim_1_2` `confidence:1.00`
...
- The frontend queries http://35.207.0.103:23313/. `claim:claim_1_3` `confidence:1.00`
...
- The IP 35.207.0.103 belongs to the GCP instance use1-aeneid-fuacet. `claim:claim_1_4` `confidence:1.00`
...
- The backend validates the frontend request, adds wallet addresses to a database table, and batch sends testnet tokens. `claim:claim_1_5` `confidence:1.00`
...
- The backend does not have a domain name; it uses the server IP directly. `claim:claim_1_6` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_43c0946f3f4587e464c535b2f02e284a` `chunk_id=srcchunk_42b6f69cb1c483b952a70161fab8aedb` `native_locator=slack:C0547N89JUB:1770083249.859729:1770969770.716529` `source_timestamp=2026-02-13T08:03:17Z`
...
- What domain name will be used for the AWS backend after migration?

## Related Pages

- `migrate-aeneid-faucet-gcp-to-aws`
