...
Aeneid faucet service for distributing testnet tokens, frontend at aeneid.faucet.story.foundation, backend on GCP instance use1-aeneid-fuacet (35.207.0.103:23313).

## Claims

- Faucet frontend URL: https://aeneid.faucet.story.foundation/ `claim:claim_1_1` `confidence:1.00`
...
- Frontend queries backend at http://35.207.0.103:23313/ `claim:claim_1_2` `confidence:1.00`
...
- Backend server is GCP instance use1-aeneid-fuacet with IP 35.207.0.103 `claim:claim_1_3` `confidence:1.00`
...
- Faucet developed by subteam @S07ASS1JQNP `claim:claim_1_4` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_dc87e72b13ffb646b259a7fc91c395d8` `chunk_id=srcchunk_3f7de3056380c3b0a128e380c3c3f79f` `native_locator=slack:C0547N89JUB:1770083249.859729:1770085370.453109` `source_timestamp=2026-02-03T02:22:50Z`
- Backend validates frontend request, adds wallet addresses to database, chronologically batch sends testnet tokens `claim:claim_1_5` `confidence:1.00`
...
- The GCP server is currently in use as of Feb 2026 `claim:claim_1_6` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_50b60006f4eeb38f39acd80cb65b8cff` `chunk_id=srcchunk_bf85328875d49cd44ea72f1a0ed48af2` `native_locator=slack:C0547N89JUB:1770083249.859729:1770971356.987109` `source_timestamp=2026-02-13T08:29:16Z`

## Open Questions

- Who currently maintains the faucet? Contact points for operations?

## Related Pages

- `aeneid-faucet-migration-decision`
