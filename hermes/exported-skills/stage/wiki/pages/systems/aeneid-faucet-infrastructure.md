---
title: "Aeneid Faucet Infrastructure"
type: "system"
...
# Aeneid Faucet Infrastructure

## Summary

The Aeneid testnet faucet backend runs on a GCP instance (use1-aeneid-fuacet) with IP 35.207.0.103, frontend at aeneid.faucet.story.foundation. Migration to AWS is planned, requiring domain-based frontend routing and access provisioning.

## Claims

- The Aeneid faucet frontend queries backend at `http://35.207.0.103:23313/`. `claim:claim_1_1` `confidence:1.00`
...
- The GCP instance `use1-aeneid-fuacet` in project `story-aeneid` has IP `35.207.0.103`. `claim:claim_1_2` `confidence:1.00`
...
- The backend adds wallet addresses to a database table, then chronologically batch sends testnet tokens. `claim:claim_1_3` `confidence:1.00`
...
- Migration of the faucet server from GCP to AWS is planned. `claim:claim_1_4` `confidence:1.00`
...
- The frontend should be updated to use a domain name instead of IP to facilitate migration. `claim:claim_1_5` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_15036f8cdcd7730d9bf3ef252d63cd08` `chunk_id=srcchunk_b8eb04c30ffaafd6bc68a3ae08061d6b` `native_locator=slack:C0547N89JUB:1770083249.859729:1770971534.533319` `source_timestamp=2026-02-13T08:32:14Z`
- GCP access (project story-aeneid) was granted to user with email Haodi@piplabs.xyz for migration. `claim:claim_1_6` `confidence:1.00`
...
- AWS access for the story-testnet account was still being provisioned at the time. `claim:claim_1_7` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_4f7762d903550900445eec55650e231b` `chunk_id=srcchunk_52a56ac87d0fdd8ad3e0a4f9f3eea3dc` `native_locator=slack:C0547N89JUB:1770083249.859729:1771034156.878539` `source_timestamp=2026-02-14T01:55:56Z`

## Open Questions

- Has the migration to AWS been completed?
- What domain name is now used for the faucet backend?
- What is the current database and batch-sending mechanism for tokens?
...
- `source_revision_id`: `srcrev_b593e7b61efeed44462aa19cfa263207`
