...
freshness: "2026-03-08T14:02:26Z"
tags:
  - "errors"
  - "incident"
  - "spike-protection"
...
Record of spike protection and error events for the story-api project, as reported in Slack channel C07K3J4JTH6.
...
- Spike protection was deactivated on 2025-12-22 11:40:07 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was activated again on 2025-12-23 11:51:02 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was deactivated on 2025-12-23 12:30:08 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was activated on 2026-01-28 12:58:51 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Multiple story-api endpoints returned 500 Internal Server Error, including POST /hub/users/notifications, POST /api/v3/*any, POST /api/v4/search, POST /api/v4/assets/edges, POST /api/v4/licenses/tokens, POST /api/v4/transactions, POST /api/v4/disputes, GET /api/v4/disputes/:disputeId, and POST /api/v4/collections. `claim:claim_1_7` `confidence:1.00`
...
- Search-related errors included 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input' and 'received status code 500'. `claim:claim_1_8` `confidence:1.00`
...
- A database password authentication failure occurred: 'FATAL #28P01 password authentication failed for user "postgres"'. `claim:claim_1_9` `confidence:1.00`
...
- An error occurred when creating an IP asset: 'null value in column "blacklisted" of relation "ip_assets" violates not-null constraint'. `claim:claim_1_10` `confidence:1.00`
...
- An error occurred when creating a user: 'null value in column "id" of relation "users" violates not-null constraint'. `claim:claim_1_11` `confidence:1.00`
...
- A parsing error occurred: 'strconv.ParseInt: parsing "99999999999999999999999": value out of range'. `claim:claim_1_12` `confidence:1.00`
...
- `source_revision_id`: `srcrev_2ff752e1f4ad1e5e8d39934671f3a715`
