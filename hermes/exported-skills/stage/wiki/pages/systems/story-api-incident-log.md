...
Log of operational events and errors observed in the Story-API system from various sources. Includes spike protection activations/deactivations and a series of 500 errors and database-related issues.

## Claims

- Spike protection was activated for story-api spans on 2025-12-22 at 10:50:56 UTC. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2025-12-22 at 11:40:07 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 2025-12-23 at 11:51:02 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2025-12-23 at 12:30:08 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 2026-01-28 at 12:58:51 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2026-01-28 at 13:30:11 UTC. `claim:claim_1_6` `confidence:1.00`
...
- story-api endpoint POST /hub/users/notifications returned a 500 error: 'Failed to list notifications'. `claim:claim_1_7` `confidence:1.00`
...
- story-api endpoint POST /api/v3/*any returned a 500 Internal Server Error. `claim:claim_1_8` `confidence:1.00`
...
- story-api endpoint POST /api/v4/search returned a 500 Internal Server Error. `claim:claim_1_9` `confidence:1.00`
...
- story-api endpoint POST /api/v4/assets/edges returned a 500 Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- story-api endpoint POST /api/v4/licenses/tokens returned a 500 Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- story-api endpoint POST /api/v4/transactions returned a 500 Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- story-api endpoint POST /api/v4/disputes returned a 500 Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- story-api endpoint GET /api/v4/disputes/:disputeId returned a 500 Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- story-api error: 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input'. `claim:claim_1_15` `confidence:1.00`
...
- story-api error: 'failed to perform search: all retries failed: received status code 500'. `claim:claim_1_16` `confidence:1.00`
...
- story-api suffered a fatal database authentication error: 'FATAL #28P01 password authentication failed for user "postgres"'. `claim:claim_1_17` `confidence:1.00`
...
- story-api error: 'failed to create IP asset: ERROR #23502 null value in column "blacklisted" of relation "ip_assets" violates not-null constraint'. `claim:claim_1_18` `confidence:1.00`
...
- story-api error: 'failed to create entity: ERROR #23502 null value in column "id" of relation "users" violates not-null constraint'. `claim:claim_1_19` `confidence:1.00`
...
- story-api endpoint POST /api/v4/collections returned a 500 Internal Server Error. `claim:claim_1_20` `confidence:1.00`
...
- story-api error: 'strconv.ParseInt: parsing "99999999999999999999999": value out of range'. `claim:claim_1_21` `confidence:1.00`
...
- story-api endpoint GET /api/v4/disputes/:disputeId returned a 500 Internal server error. `claim:claim_1_22` `confidence:1.00`
...
- `source_revision_id`: `srcrev_3fa0db411e5144885bb91e4c5fb1669c`
