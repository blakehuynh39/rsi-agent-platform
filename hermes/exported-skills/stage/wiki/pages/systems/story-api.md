...
The story-api service experienced several incidents between 2025-12-22 and 2026-03-09, including spike protection activations and various internal server errors.

## Claims

- On 2025-12-22 at 10:50:56 UTC, spike protection for story-api spans was activated. `claim:claim_1_1` `confidence:1.00`
...
- On 2025-12-22 at 11:40:07 UTC, spike protection for story-api spans was deactivated. `claim:claim_1_2` `confidence:1.00`
...
- On 2025-12-23 at 11:51:02 UTC, spike protection for story-api spans was activated. `claim:claim_1_3` `confidence:1.00`
...
- On 2025-12-23 at 12:30:08 UTC, spike protection for story-api spans was deactivated. `claim:claim_1_4` `confidence:1.00`
...
- On 2026-01-28 at 12:58:51 UTC, spike protection for story-api spans was activated. `claim:claim_1_5` `confidence:1.00`
...
- On 2026-01-28 at 13:30:11 UTC, spike protection for story-api spans was deactivated. `claim:claim_1_6` `confidence:1.00`
...
- Around 2026-01-04, POST /hub/users/notifications failed with 500: Failed to list notifications. `claim:claim_1_7` `confidence:1.00`
...
- Around 2026-01-04, POST /api/v3/*any failed with 500: Internal Server Error. `claim:claim_1_8` `confidence:1.00`
...
- Around 2026-01-04, POST /api/v4/search failed with 500: Internal Server Error. `claim:claim_1_9` `confidence:1.00`
...
- Around 2026-02-06, POST /api/v4/assets/edges failed with 500: Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- Around 2026-02-06, POST /api/v4/licenses/tokens failed with 500: Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- Around 2026-02-06, POST /api/v4/transactions failed with 500: Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- Around 2026-02-06, POST /api/v4/disputes failed with 500: Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- Around 2026-02-06, GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- A search failure occurred: all retries failed with 'unexpected end of JSON input'. `claim:claim_1_15` `confidence:1.00`
...
- A search failure occurred: all retries failed with received status code 500. `claim:claim_1_16` `confidence:1.00`
...
- PostgreSQL password authentication failed for user 'postgres'. `claim:claim_1_17` `confidence:1.00`
...
- A not-null constraint violation occurred: null value in column 'blacklisted' of relation 'ip_assets'. `claim:claim_1_18` `confidence:1.00`
...
- A not-null constraint violation occurred: null value in column 'id' of relation 'users'. `claim:claim_1_19` `confidence:1.00`
...
- Around 2026-02-12, POST /api/v4/collections failed with 500: Internal Server Error. `claim:claim_1_20` `confidence:1.00`
...
- An integer parse error occurred: strconv.ParseInt: parsing "99999999999999999999999": value out of range. `claim:claim_1_21` `confidence:1.00`
...
- Around 2026-02-25, GET /api/v4/disputes/:disputeId failed with 500: Internal server error. `claim:claim_1_22` `confidence:1.00`
...
- Are the spike protection events related to the subsequent error surges?
- What is the underlying cause of the recurring 500 errors and database constraint violations?
- What triggered the spike protection activations?

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_0164320d94e22ef2212b2090ccb11839`
