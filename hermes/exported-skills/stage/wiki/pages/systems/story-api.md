...
story-api is an internal service that has experienced periodic 500 errors, spike protection events, and database issues.

## Claims

- Spike protection was activated for story-api spans on 2025-12-22 10:50:56 UTC. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2025-12-22 11:40:07 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 2025-12-23 11:51:02 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2025-12-23 12:30:08 UTC. `claim:claim_1_4` `confidence:1.00`
...
- At 2026-01-12 04:33:41 UTC, story-api POST /hub/users/notifications failed with 500: Failed to list notifications. `claim:claim_1_5` `confidence:1.00`
...
- At 2026-01-12 04:45:20 UTC, story-api POST /api/v3/*any failed with 500: Internal Server Error. `claim:claim_1_6` `confidence:1.00`
...
- At 2026-01-12 07:36:01 UTC, story-api POST /api/v4/search failed with 500: Internal Server Error. `claim:claim_1_7` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 2026-01-28 12:58:51 UTC. `claim:claim_1_8` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2026-01-28 13:30:11 UTC. `claim:claim_1_9` `confidence:1.00`
...
- At 2026-02-25 12:35:37 UTC, story-api POST /api/v4/assets/edges failed with 500: Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- At 2026-02-25 12:35:41 UTC, story-api POST /api/v4/licenses/tokens failed with 500: Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- At 2026-02-25 12:35:41 UTC, story-api POST /api/v4/transactions failed with 500: Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- At 2026-02-25 12:35:42 UTC, story-api POST /api/v4/disputes failed with 500: Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- At 2026-02-25 12:43:31 UTC, story-api GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- At 2026-02-25 13:34:20 UTC, story-api encountered a search error: failed to unmarshal response: unexpected end of JSON input. `claim:claim_1_15` `confidence:1.00`
...
- At 2026-02-25 13:50:27 UTC, story-api encountered a search error: received status code 500. `claim:claim_1_16` `confidence:1.00`
...
- At 2026-02-26 11:30:19 UTC, story-api database authentication failed for user "postgres". `claim:claim_1_17` `confidence:1.00`
...
- At 2026-02-27 11:47:34 UTC, story-api failed to create IP asset due to null "blacklisted" column violating not-null constraint. `claim:claim_1_18` `confidence:1.00`
...
- At 2026-02-27 14:45:40 UTC, story-api failed to create user entity due to null "id" column violating not-null constraint. `claim:claim_1_19` `confidence:1.00`
...
- At 2026-03-02 12:58:00 UTC, story-api POST /api/v4/collections failed with 500: Internal Server Error. `claim:claim_1_20` `confidence:1.00`
...
- At 2026-03-04 16:42:26 UTC, story-api encountered a parsing error: value out of range for big integer. `claim:claim_1_21` `confidence:1.00`
...
- At 2026-03-04 16:42:47 UTC, story-api GET /api/v4/disputes/:disputeId failed with 500: Internal server error. `claim:claim_1_22` `confidence:1.00`
...
- On 2024-10-29 03:23:19 UTC, a user reported that many endpoints appear to be working but further investigation in Sentry is needed to identify the issue. `claim:claim_1_23` `confidence:1.00`
...
- `source_revision_id`: `srcrev_c784480c6a9fccae58e5d1bb6f28dee9`
