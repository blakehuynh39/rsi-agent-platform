...
Log of error events and spike protection status changes for the story-api service.
...
- POST /api/v4/assets/edges failed with 500: Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- POST /api/v4/licenses/tokens failed with 500: Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- POST /api/v4/transactions failed with 500: Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- POST /api/v4/disputes failed with 500: Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- Error during search: 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input'. `claim:claim_1_15` `confidence:1.00`
...
- Error during search: 'failed to perform search: all retries failed: received status code 500'. `claim:claim_1_16` `confidence:1.00`
...
- Fatal database connection error: password authentication failed for user 'postgres' (FATAL #28P01). `claim:claim_1_17` `confidence:1.00`
...
- Failed to create IP asset: null value in column 'blacklisted' violates not-null constraint (ERROR #23502). `claim:claim_1_18` `confidence:1.00`
...
- Failed to create entity: null value in column 'id' violates not-null constraint (ERROR #23502). `claim:claim_1_19` `confidence:1.00`
...
- POST /api/v4/collections failed with 500: Internal Server Error. `claim:claim_1_20` `confidence:1.00`
...
- strconv.ParseInt error: parsing '99999999999999999999999': value out of range. `claim:claim_1_21` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal server error. `claim:claim_1_22` `confidence:1.00`
...
- What is the root cause of the 500 Internal Server Errors?
- What triggers spike protection activation, and is it related to error spikes?
- Why did password authentication for the PostgreSQL database fail?

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_8b9e54067c6b33d524350ee2066b563f`
