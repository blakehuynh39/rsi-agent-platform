...
Story-api service observations from monitoring channel. Includes spike protection events and internal server errors.

## Claims

- Initial check: For many of the endpoints related, they seem to be working. But will need to access sentry to see the exact request that created the issue. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection has been activated for the project story-api for spans on 12/22/2025, 10:50:56 UTC `claim:claim_1_2` `confidence:1.00`
...
- Spike protection has been deactivated for the project story-api for spans on 12/22/2025, 11:40:07 UTC `claim:claim_1_3` `confidence:1.00`
...
- Spike protection has been activated for the project story-api for spans on 12/23/2025, 11:51:02 UTC `claim:claim_1_4` `confidence:1.00`
...
- Spike protection has been deactivated for the project story-api for spans on 12/23/2025, 12:30:08 UTC `claim:claim_1_5` `confidence:1.00`
...
- Spike protection has been activated for the project story-api for spans on 01/28/2026, 12:58:51 UTC `claim:claim_1_6` `confidence:1.00`
...
- Spike protection has been deactivated for the project story-api for spans on 01/28/2026, 13:30:11 UTC `claim:claim_1_7` `confidence:1.00`
...
- [story-api] POST /hub/users/notifications failed with 500: Failed to list notifications `claim:claim_1_8` `confidence:1.00`
...
- [story-api] POST /api/v3/*any failed with 500: Internal Server Error `claim:claim_1_9` `confidence:1.00`
...
- [story-api] POST /api/v4/search failed with 500: Internal Server Error `claim:claim_1_10` `confidence:1.00`
...
- [story-api] POST /api/v4/assets/edges failed with 500: Internal Server Error `claim:claim_1_11` `confidence:1.00`
...
- [story-api] POST /api/v4/licenses/tokens failed with 500: Internal Server Error `claim:claim_1_12` `confidence:1.00`
...
- [story-api] POST /api/v4/transactions failed with 500: Internal Server Error `claim:claim_1_13` `confidence:1.00`
...
- [story-api] POST /api/v4/disputes failed with 500: Internal Server Error `claim:claim_1_14` `confidence:1.00`
...
- [story-api] GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error `claim:claim_1_15` `confidence:1.00`
...
- [story-api] errors.withStack: failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input `claim:claim_1_16` `confidence:1.00`
...
- [story-api] errors.withStack: failed to perform search: all retries failed: received status code 500 `claim:claim_1_17` `confidence:1.00`
...
- [story-api] errors.withStack: FATAL #28P01 password authentication failed for user "postgres" `claim:claim_1_18` `confidence:1.00`
...
- [story-api] errors.withStack: failed to create IP asset: ERROR #23502 null value in column "blacklisted" of relation "ip_assets" violates not-null constraint `claim:claim_1_19` `confidence:1.00`
...
- [story-api] errors.withStack: failed to create entity: ERROR #23502 null value in column "id" of relation "users" violates not-null constraint `claim:claim_1_20` `confidence:1.00`
...
- [story-api] POST /api/v4/collections failed with 500: Internal Server Error `claim:claim_1_21` `confidence:1.00`
...
- [story-api] errors.withStack: strconv.ParseInt: parsing "99999999999999999999999": value out of range `claim:claim_1_22` `confidence:1.00`
...
- [story-api] GET /api/v4/disputes/:disputeId failed with 500: Internal server error `claim:claim_1_23` `confidence:1.00`
...
- `source_revision_id`: `srcrev_c6dea59e8af51003f59c882c01bc9ca0`
