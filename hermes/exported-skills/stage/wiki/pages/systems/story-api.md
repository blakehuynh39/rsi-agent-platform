...
Monitoring and incident history for the story-api service. Includes spike protection events and various server errors observed in Slack notifications.

## Claims

- Checking them `claim:claim_1_1` `confidence:1.00`
...
- For many of the endpoints related, they seem to be working. But will need to access sentry to see the exact request that created the issue `claim:claim_1_2` `confidence:1.00`
...
- Spike protection has been activated for the project *story-api* for *spans* on 12/22/2025, 10:50:56 UTC `claim:claim_1_3` `confidence:1.00`
...
- Spike protection has been deactivated for the project *story-api* for *spans* on 12/22/2025, 11:40:07 UTC `claim:claim_1_4` `confidence:1.00`
...
- Spike protection has been activated for the project *story-api* for *spans* on 12/23/2025, 11:51:02 UTC `claim:claim_1_5` `confidence:1.00`
...
- Spike protection has been deactivated for the project *story-api* for *spans* on 12/23/2025, 12:30:08 UTC `claim:claim_1_6` `confidence:1.00`
...
- Spike protection has been activated for the project *story-api* for *spans* on 01/28/2026, 12:58:51 UTC `claim:claim_1_7` `confidence:1.00`
...
- Spike protection has been deactivated for the project *story-api* for *spans* on 01/28/2026, 13:30:11 UTC `claim:claim_1_8` `confidence:1.00`
...
- [story-api] POST /hub/users/notifications failed with 500: Failed to list notifications `claim:claim_1_9` `confidence:1.00`
...
- [story-api] POST /api/v3/*any failed with 500: Internal Server Error `claim:claim_1_10` `confidence:1.00`
...
- [story-api] POST /api/v4/search failed with 500: Internal Server Error `claim:claim_1_11` `confidence:1.00`
...
- [story-api] POST /api/v4/assets/edges failed with 500: Internal Server Error `claim:claim_1_12` `confidence:1.00`
...
- [story-api] POST /api/v4/licenses/tokens failed with 500: Internal Server Error `claim:claim_1_13` `confidence:1.00`
...
- [story-api] POST /api/v4/transactions failed with 500: Internal Server Error `claim:claim_1_14` `confidence:1.00`
...
- [story-api] POST /api/v4/disputes failed with 500: Internal Server Error `claim:claim_1_15` `confidence:1.00`
...
- [story-api] GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error `claim:claim_1_16` `confidence:1.00`
...
- [story-api] *errors.withStack: failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input `claim:claim_1_17` `confidence:1.00`
...
- [story-api] *errors.withStack: failed to perform search: all retries failed: received status code 500 `claim:claim_1_18` `confidence:1.00`
...
- [story-api] *errors.withStack: FATAL #28P01 password authentication failed for user "postgres" `claim:claim_1_19` `confidence:1.00`
...
- [story-api] *errors.withStack: failed to create IP asset: ERROR #23502 null value in column "blacklisted" of relation "ip_assets" violates not-null constraint `claim:claim_1_20` `confidence:1.00`
...
- [story-api] *errors.withStack: failed to create entity: ERROR #23502 null value in column "id" of relation "users" violates not-null constraint `claim:claim_1_21` `confidence:1.00`
...
- [story-api] POST /api/v4/collections failed with 500: Internal Server Error `claim:claim_1_22` `confidence:1.00`
...
- [story-api] *errors.withStack: strconv.ParseInt: parsing "99999999999999999999999": value out of range `claim:claim_1_23` `confidence:1.00`
...
- [story-api] GET /api/v4/disputes/:disputeId failed with 500: Internal server error `claim:claim_1_24` `confidence:1.00`
...
- Are the repeated spike protection activations correlated with the search-related timeout or failure errors?
- Is the database connection stable? The password authentication failure suggests a potential misconfiguration or expired credentials.
- What input or request causes the integer overflow in ParseInt (parsing '99999999999999999999999')?
- What is the root cause of the recurring 500 errors across multiple endpoints?
- What triggers spike protection for story-api spans?
- Why are not-null constraint violations occurring on ip_assets.blacklisted and users.id? Are application code or database migrations missing default values?

## Related Pages

- `spike-protection-policy`
- `story-api-incidents`

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_453fb7b54987d47369dbd44173781667`
