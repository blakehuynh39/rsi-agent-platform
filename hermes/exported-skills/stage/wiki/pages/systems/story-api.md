...
Backend API service for story-related functionality. Recent logs from Slack channel C07K3J4JTH6 show spike protection events and various 500 Internal Server errors.

## Claims

- Spike protection was activated for the story-api project for spans on 2025-12-22 at 10:50:56 UTC. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was deactivated for the story-api project for spans on 2025-12-22 at 11:40:07 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was activated for the story-api project for spans on 2025-12-23 at 11:51:02 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was deactivated for the story-api project for spans on 2025-12-23 at 12:30:08 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was activated for the story-api project for spans on 2026-01-28 at 12:58:51 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection was deactivated for the story-api project for spans on 2026-01-28 at 13:30:11 UTC. `claim:claim_1_6` `confidence:1.00`
...
- POST /hub/users/notifications endpoint failed with HTTP 500 and message 'Failed to list notifications'. `claim:claim_1_7` `confidence:1.00`
...
- POST /api/v3/*any endpoint failed with HTTP 500 Internal Server Error. `claim:claim_1_8` `confidence:1.00`
...
- POST /api/v4/search endpoint failed with HTTP 500 Internal Server Error. `claim:claim_1_9` `confidence:1.00`
...
- POST /api/v4/assets/edges endpoint failed with HTTP 500 Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- POST /api/v4/licenses/tokens endpoint failed with HTTP 500 Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- POST /api/v4/transactions endpoint failed with HTTP 500 Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- POST /api/v4/disputes endpoint failed with HTTP 500 Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId endpoint failed with HTTP 500 Internal Server Error (first occurrence). `claim:claim_1_14` `confidence:1.00`
...
- Search operation failed due to 'unexpected end of JSON input' after all retries. `claim:claim_1_15` `confidence:1.00`
...
- Search operation failed with status code 500 after all retries. `claim:claim_1_16` `confidence:1.00`
...
- Database authentication failed with FATAL error #28P01: password authentication failed for user 'postgres'. `claim:claim_1_17` `confidence:1.00`
...
- IP asset creation failed due to not-null constraint violation on column 'blacklisted' (SQL error #23502). `claim:claim_1_18` `confidence:1.00`
...
- User entity creation failed due to not-null constraint violation on column 'id' (SQL error #23502). `claim:claim_1_19` `confidence:1.00`
...
- POST /api/v4/collections endpoint failed with HTTP 500 Internal Server Error. `claim:claim_1_20` `confidence:1.00`
...
- A string-to-integer conversion failed because the value '99999999999999999999999' exceeded the integer range. `claim:claim_1_21` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId endpoint failed with HTTP 500 Internal Server Error (second occurrence). `claim:claim_1_22` `confidence:1.00`
...
- `source_revision_id`: `srcrev_714aafecd06b4812d0a226a3123451c5`
