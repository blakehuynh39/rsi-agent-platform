...
The story-api service experiences intermittent spike protection events and a variety of internal server errors, including database authentication failures, null constraint violations, and parsing errors.

## Claims

- Spike protection was activated for story-api for spans on 2025-12-22 10:50:56 UTC. `claim:spike-protection-2025-12-22-activated` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 2025-12-22 11:40:07 UTC. `claim:spike-protection-2025-12-22-deactivated` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 2025-12-23 11:51:02 UTC. `claim:spike-protection-2025-12-23-activated` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 2025-12-23 12:30:08 UTC. `claim:spike-protection-2025-12-23-deactivated` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 2026-01-28 12:58:51 UTC. `claim:spike-protection-2026-01-28-activated` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 2026-01-28 13:30:11 UTC. `claim:spike-protection-2026-01-28-deactivated` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /hub/users/notifications with message 'Failed to list notifications'. `claim:error-500-hub-users-notifications` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /api/v3/*any with message 'Internal Server Error'. `claim:error-500-api-v3-any` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /api/v4/search with message 'Internal Server Error'. `claim:error-500-api-v4-search` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /api/v4/assets/edges with message 'Internal Server Error'. `claim:error-500-api-v4-assets-edges` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /api/v4/licenses/tokens with message 'Internal Server Error'. `claim:error-500-api-v4-licenses-tokens` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /api/v4/transactions with message 'Internal Server Error'. `claim:error-500-api-v4-transactions` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /api/v4/disputes with message 'Internal Server Error'. `claim:error-500-api-v4-disputes-post` `confidence:1.00`
...
- story-api returned HTTP 500 on GET /api/v4/disputes/:disputeId with message 'Internal Server Error'. `claim:error-500-api-v4-disputes-get` `confidence:1.00`
...
- story-api search failed with 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input'. `claim:error-search-unmarshal` `confidence:1.00`
...
- story-api search failed with 'failed to perform search: all retries failed: received status code 500'. `claim:error-search-500` `confidence:1.00`
...
- story-api encountered a database authentication failure: 'FATAL #28P01 password authentication failed for user "postgres"'. `claim:error-db-auth` `confidence:1.00`
...
- story-api failed to create IP asset due to null value in column 'blacklisted' of relation 'ip_assets' (not-null constraint violation). `claim:error-db-null-ip_assets-blacklisted` `confidence:1.00`
...
- story-api failed to create entity due to null value in column 'id' of relation 'users' (not-null constraint violation). `claim:error-db-null-users-id` `confidence:1.00`
...
- story-api returned HTTP 500 on POST /api/v4/collections with message 'Internal Server Error'. `claim:error-500-api-v4-collections` `confidence:1.00`
...
- story-api encountered a parsing error: 'strconv.ParseInt: parsing "99999999999999999999999": value out of range'. `claim:error-parse-int-out-of-range` `confidence:1.00`
...
- story-api returned HTTP 500 on GET /api/v4/disputes/:disputeId with message 'Internal server error'. `claim:error-500-api-v4-disputes-get-2` `confidence:1.00`
...
- `source_revision_id`: `srcrev_99e7afea9d2273c02ed5076bf441e4b7`
