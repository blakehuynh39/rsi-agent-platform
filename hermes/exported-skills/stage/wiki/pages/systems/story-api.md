...
The Story-API system experienced multiple occurrences of a fatal stream error in a shard task between 2026-06-15 and 2026-06-24. The error was tracked in Sentry as issue STORY-API-ES and was resolved twice, by Romain Magne and then Blake Huynh.

## Claims

- On 2026-06-15T08:31:40Z, the story-api reported a fatal stream error: 'shard task returned a fatal stream error'. `claim:claim_1_1` `confidence:1.00`
...
- On 2026-06-16T01:12:39Z, Romain Magne (romain.magne@piplabs.xyz) marked the Sentry issue STORY-API-ES as resolved. `claim:claim_1_2` `confidence:1.00`
...
- On 2026-06-17T07:04:18Z, the story-api again reported a fatal stream error: 'shard task returned a fatal stream error'. `claim:claim_1_3` `confidence:1.00`
...
- On 2026-06-21T11:00:33Z, the story-api again reported a fatal stream error: 'shard task returned a fatal stream error'. `claim:claim_1_4` `confidence:1.00`
...
- On 2026-06-24T01:18:23Z, Blake Huynh (blake.huynh@storyprotocol.xyz) marked the Sentry issue STORY-API-ES as resolved. `claim:claim_1_5` `confidence:1.00`
...
- `source_revision_id`: `srcrev_f8550e9d00fc511801b90b1b88005fb5`
