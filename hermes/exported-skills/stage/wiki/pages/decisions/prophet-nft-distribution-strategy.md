...
owners: []
source_revision_ids:
  - "srcrev_9af7d7e6c626f001b11b759c1b693376"
conflict_state: "none"
---

# Prophet NFT Distribution and Wallet Strategy

## Summary

The team evaluated airdrop vs minting for Prophet NFTs, leaning toward a simple minting page with airdrop fallback for non-web3 users. Educational wallet resources and a create-wallet backup feature were also proposed.
...
- Will there be more Prophets in the future?

## Sources

- `source_document_id`: `srcdoc_3d6873802fd780fc70d460df16202716`
- `source_revision_id`: `srcrev_9af7d7e6c626f001b11b759c1b693376`
- `source_url`: [Notion source](https://www.notion.so/Prophet-NFT-distribution-wallets-f60ecad869ec40d08201af791048a781)
