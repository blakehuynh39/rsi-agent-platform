---
title: "GitHub PAT rotation for story-private-fork (Jan 2026)"
type: "decision"
...
# GitHub PAT rotation for story-private-fork (Jan 2026)

## Summary

Urgent rotation of a GitHub personal access token used in the story-private-fork repository's GitHub Actions workflow on 2026-01-15.

## Claims

- A GitHub personal access token (PAT) was used in the `story-private-fork` repository's GitHub Actions workflow at `.github/workflows/build-release-artifacts.yml` line 46. `claim:claim_1_1` `confidence:1.00`
...
- The token might have been created at the GitHub organization level by user @U08332YRB7W. `claim:claim_1_2` `confidence:1.00`
...
- Due to urgency, a new PAT was issued by user @U07TNT9N4JC and the existing token was replaced. `claim:claim_1_3` `confidence:1.00`
...
- The PAT issue was resolved on the same day. `claim:claim_1_4` `confidence:1.00`
...
- Who originally created the PAT used in story-private-fork? It was not definitively identified.

## Sources

- `source_document_id`: `srcdoc_4d05b3a3fc2274b7c80534a1bb379745`
- `source_revision_id`: `srcrev_262ad47e7adb91807e7600b582ba3eb4`
