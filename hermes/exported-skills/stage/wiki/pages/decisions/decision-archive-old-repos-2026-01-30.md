---
title: "Archive unused repositories (2026-01-30)"
type: "decision"
...
# Archive unused repositories (2026-01-30)

## Summary

Decision to archive a set of old, unused repositories that have not seen commits in over a year.

## Claims

- The following repositories were identified for potential archiving: story-golden-image, iac-pro, terraform-modules, iac-max, iac-max-modules, story-terraform, provision-hardened-node, story-vpc-gcp. `claim:claim_1_1` `confidence:1.00`
...
- It is safe to archive them if the last commit was over one year ago. `claim:claim_1_2` `confidence:1.00`
...
- Team members agreed to archive the listed repositories. `claim:claim_1_3` `confidence:1.00`
...
- `source_revision_id`: `srcrev_6860e0662fa5731ed0b390d06e655676`
