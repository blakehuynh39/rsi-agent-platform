---
title: "Faucet Migration: GCP to AWS"
type: "decision"
...
Decision to migrate the Aeneid testnet faucet backend from its current GCP instance (use1-aeneid-fuacet) to AWS. The frontend will be pointed to a domain instead of a hardcoded IP, allowing seamless migration. Access to required accounts is being arranged, with GCP access granted but AWS access pending due to an email issue.

## Claims

- Decision to migrate faucet backend from GCP to AWS `claim:claim_2_1` `confidence:1.00`
...
- Frontend should point to a domain instead of an IP to facilitate migration `claim:claim_2_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_15036f8cdcd7730d9bf3ef252d63cd08` `chunk_id=srcchunk_b8eb04c30ffaafd6bc68a3ae08061d6b` `native_locator=slack:C0547N89JUB:1770083249.859729:1770971534.533319` `source_timestamp=2026-02-13T08:32:14Z`
- U07TNT9N4JC is needed to set up the AWS instance `claim:claim_2_3` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_15036f8cdcd7730d9bf3ef252d63cd08` `chunk_id=srcchunk_b8eb04c30ffaafd6bc68a3ae08061d6b` `native_locator=slack:C0547N89JUB:1770083249.859729:1770971534.533319` `source_timestamp=2026-02-13T08:32:14Z`
- U0643B9PPC1 requires access to both the old GCP server and the new AWS server for migration `claim:claim_2_4` `confidence:1.00`
...
- GCP project for the faucet is story-aeneid `claim:claim_2_5` `confidence:1.00`
...
- AWS account for the migration is story-testnet `claim:claim_2_6` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_2729f1cdf2797dbe69c29554151a9905` `chunk_id=srcchunk_2a3b7fa2db993f52fdcf4a3068729d22` `native_locator=slack:C0547N89JUB:1770083249.859729:1771024705.562899` `source_timestamp=2026-02-13T23:18:25Z`
- GCP access has been granted to U0643B9PPC1 `claim:claim_2_7` `confidence:1.00`
...
- AWS access for U0643B9PPC1 is still being worked on `claim:claim_2_8` `confidence:1.00`
  - citation: `source_document_id=srcdoc_39d343ffa196af216bd4ea35c17da039` `source_revision_id=srcrev_4f7762d903550900445eec55650e231b` `chunk_id=srcchunk_52a56ac87d0fdd8ad3e0a4f9f3eea3dc` `native_locator=slack:C0547N89JUB:1770083249.859729:1771034156.878539` `source_timestamp=2026-02-14T01:55:56Z`
- Intended login email for U0643B9PPC1 is Haodi@piplabs.xyz `claim:claim_2_9` `confidence:1.00`
...
- Haodi@piplabs.xyz email is suspended, blocking Google login `claim:claim_2_10` `confidence:1.00`
...
- ETA for AWS instance setup and completion of migration?
- How to provide AWS access to U0643B9PPC1 given the Haodi@piplabs.xyz email is suspended? Perhaps use a poseidon email?
...
- `source_revision_id`: `srcrev_7db7c59341cb14ca822b5c3a1c7b44d5`
