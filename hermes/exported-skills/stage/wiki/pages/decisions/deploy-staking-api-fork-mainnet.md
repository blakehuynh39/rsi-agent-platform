---
title: "Deploy story-staking-api-private-fork for Mainnet"
type: "decision"
...
# Deploy story-staking-api-private-fork for Mainnet

## Summary

Deployment request for story-staking-api-private-fork on mainnet, postponed then assigned to U09M2SPUTSL to liaise with BitGo team.

## Claims

- A deployment of story-staking-api-private-fork for mainnet was requested. `claim:claim_1_1` `confidence:1.00`
...
- The deployment requires a newly synced archive node, and all archive nodes have been updated so the existing endpoint can be used. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_4a7ce59a30ad54516f0ac7d868f659ed` `source_revision_id=srcrev_54b11acf7c453892731fab08e11effcd` `chunk_id=srcchunk_96d5636f18147a5bc249211f830b23cb` `native_locator=slack:C0547N89JUB:1768273154.814879:1768273154.814879` `source_timestamp=2026-01-13T02:59:14Z`
- The deployment was initially postponed to next week due to lack of bandwidth. `claim:claim_1_3` `confidence:1.00`
...
- There is urgency because the BitGo team needs it, and investors are chasing them. `claim:claim_1_4` `confidence:1.00`
...
- The task was assigned to U09M2SPUTSL to liaise with the BitGo team. `claim:claim_1_5` `confidence:1.00`
...
- `source_revision_id`: `srcrev_74175231c7d529f13df1a336cf96e949`
