---
title: "Mainnet Story Staking API Private Fork Deployment"
type: "decision"
slug: "decisions/mainnet-story-staking-api-private-fork-deployment"
freshness: "2026-01-13T03:49:37Z"
tags:
  - "archive-node"
  - "deployment"
  - "mainnet"
...
# Mainnet Story Staking API Private Fork Deployment

## Summary

Deployment of story-staking-api-private-fork to mainnet was requested, postponed to next week due to bandwidth, with urgency from BitGo/investors. Assignment passed to @U09M2SPUTSL.

## Claims

- Deployment of story-staking-api-private-fork to mainnet was requested. `claim:claim_1_1` `confidence:1.00`
...
- The deployment should use a newly synced archive node, with existing endpoints potentially reusable. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_4a7ce59a30ad54516f0ac7d868f659ed` `source_revision_id=srcrev_54b11acf7c453892731fab08e11effcd` `chunk_id=srcchunk_96d5636f18147a5bc249211f830b23cb` `native_locator=slack:C0547N89JUB:1768273154.814879:1768273154.814879` `source_timestamp=2026-01-13T02:59:14Z`
- The task was postponed to the following week due to @U07TNT9N4JC's lack of bandwidth. `claim:claim_1_3` `confidence:1.00`
...
- There was urgency from the BitGo team and investors to complete the indexing on mainnet. `claim:claim_1_4` `confidence:1.00`
...
- @U09M2SPUTSL took over responsibility to liaise and proceed with the deployment. `claim:claim_1_5` `confidence:1.00`
...
- Has the deployment been initiated/completed?
- When will the mainnet indexing be done?
...
- `archive-node-setup`
- `bitgo-integration`
- `story-staking-api-private-fork`

## Sources

- `source_document_id`: `srcdoc_4a7ce59a30ad54516f0ac7d868f659ed`
- `source_revision_id`: `srcrev_75f4e7452b8cc505a2c75edb6597ab39`
