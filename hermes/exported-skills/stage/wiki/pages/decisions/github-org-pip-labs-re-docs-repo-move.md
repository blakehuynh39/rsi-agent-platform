---
title: "PIP-Labs-RE Docs Repository Migration and Branch Protection Decision"
type: "decision"
...
# PIP-Labs-RE Docs Repository Migration and Branch Protection Decision

## Summary

Decision to create a new GitHub org PIP-Labs-RE to host the docs repository, bypassing enterprise branch protection rules to allow direct pushes, while eventually agreeing on requiring at least one approver for public-facing repos.

## Claims

- The PIP-Labs-RE GitHub organization was created to host the docs repository and circumvent an enterprise-level branch protection rule that prevented Jacob from merging without approval. `claim:claim_1_1` `confidence:1.00`
...
- The repository is public in the new org with lenient branch protection rules, initially allowing direct pushes to main. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_e3f1cd8eff335b482cd951577e5b8bcb` `source_revision_id=srcrev_d30b1d9d46379fa2550093046376c04a` `chunk_id=srcchunk_86a5002dc07947f9fdfbb4b4c0ffd777` `native_locator=slack:C0547N89JUB:1769627331.711949:1769736144.699799` `source_timestamp=2026-01-30T01:22:24Z`
...
- Multiple users encountered issues being added as reviewers to PR #48 due to missing org membership and repo permissions. `claim:claim_1_3` `confidence:1.00`
...
- Meng was added as an outside collaborator and invited to the organization; he needed to accept both invites to appear as a reviewer. `claim:claim_1_4` `confidence:1.00`
...
- GitHub Enterprise allows branch protection exceptions at repository visibility and branch levels, but the separation was done to grant Jacob direct push access as sole maintainer. `claim:claim_1_5` `confidence:1.00`
  - citation: `source_document_id=srcdoc_e3f1cd8eff335b482cd951577e5b8bcb` `source_revision_id=srcrev_e8b30516e765ac8fb663f988de7f3623` `chunk_id=srcchunk_f4e821e3bed97dc456d299b0643dd8de` `native_locator=slack:C0547N89JUB:1769627331.711949:1769743802.301819` `source_timestamp=2026-01-30T03:30:02Z`
- The team agrees that having at least one approver for the public-facing repository is preferable. `claim:claim_1_6` `confidence:1.00`
...
- Was the branch protection rule eventually updated to require at least one approver? The discussion indicates agreement but no final confirmation of implementation.

## Related Pages

- `github-enterprise-branch-protection-policy`
- `pip-labs-re-repo-management`

## Sources

- `source_document_id`: `srcdoc_e3f1cd8eff335b482cd951577e5b8bcb`
- `source_revision_id`: `srcrev_209c303befe3d89b0f601b1f6d270a1a`
