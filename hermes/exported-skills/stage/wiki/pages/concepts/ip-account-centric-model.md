...
freshness: "2023-12-28T19:11:00Z"
tags:
  - "ethereum"
  - "identity"
  - "ip-account"
...
owners: []
source_revision_ids:
  - "srcrev_9a582c56fd6af14f5a8da8b30191bbfb"
conflict_state: "none"
---
...
The IP Account Centric Model conceptualizes IPAccount as the core identity (noun) and Modules as actions (verbs). IP Accounts represent IP as real entities on Ethereum, with IP NFTs serving as identity tokens. IPAccounts can hold license/royalty NFTs, store state, and initiate actions via modules, while an Orchestrator authorizes interactions.

## Claims

- IPAccount serves as the core identity for all actions in the system. `claim:claim_1_1` `confidence:1.00`
  - citation: [Notion source](https://www.notion.so/WIP-IP-Account-Centric-Model-e42b87c6956749318c06c9b051905dd9) `source_document_id=srcdoc_c8cbb3ac616a2a6f13cba1ddb9080238` `source_revision_id=srcrev_9a582c56fd6af14f5a8da8b30191bbfb` `chunk_id=srcchunk_308e37159e31b9b5899691f2193d5f82` `native_locator=https://www.notion.so/WIP-IP-Account-Centric-Model-e42b87c6956749318c06c9b051905dd9` `source_timestamp=2023-12-28T19:11:00Z`
...
- `source_revision_id`: `srcrev_9a582c56fd6af14f5a8da8b30191bbfb`
- `source_url`: [Notion source](https://www.notion.so/WIP-IP-Account-Centric-Model-e42b87c6956749318c06c9b051905dd9)
