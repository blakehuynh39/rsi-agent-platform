...
freshness: "2024-07-05T11:04:00Z"
tags:
  - "ip-graph"
  - "precompile"
  - "requirements"
...
- The IP Graph must support up to 8 parent nodes (P0 priority). `claim:claim_ipgraph_1` `confidence:1.00`
  - citation: [Notion source](https://www.notion.so/IP-Graph-dfd3e08ae70d4ba69244a9c425a2e1aa) `source_document_id=srcdoc_8e252c1e515cf07abd1a2bb883c80f80` `source_revision_id=srcrev_97af278f1741ae1dc3cef71f27e57f88` `chunk_id=srcchunk_c51eb9ba9fb784d5bd7e3b7d16a62e3a` `native_locator=https://www.notion.so/IP-Graph-dfd3e08ae70d4ba69244a9c425a2e1aa` `source_timestamp=2024-07-05T11:04:00Z`
