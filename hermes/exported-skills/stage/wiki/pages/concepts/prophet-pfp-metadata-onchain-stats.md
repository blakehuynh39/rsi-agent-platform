...
owners: []
source_revision_ids:
  - "srcrev_def98f022ec5c3da7e1ff94e39e1df35"
conflict_state: "none"
---

# Prophet PFP Metadata to Reflect On-Chain Protocol Stats

## Summary

The concept involves NFT metadata dynamically reflecting on-chain statistics such as number of collects, relationships, license type. It aims to provide a fun and convenient showcase of IP Asset stats. Still in idea stage, with technical feasibility under assessment. Proposed engineering approach uses IPFS/Arweave for metadata hosting with a dynamic API endpoint.
...
- How will the IPFS/Arweave backend handle RPC calls and query on-chain stats dynamically?

## Sources

- `source_document_id`: `srcdoc_46256ec0d6eeaa4f062aca1a3a516623`
- `source_revision_id`: `srcrev_def98f022ec5c3da7e1ff94e39e1df35`
- `source_url`: [Notion source](https://www.notion.so/Prophet-PFP-metadata-to-reflect-Protocol-stats-2437208350c84d8d8c8383ed6da691a1)
