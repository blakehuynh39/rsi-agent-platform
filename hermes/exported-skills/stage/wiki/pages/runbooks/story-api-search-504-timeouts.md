---
title: "Story-API /api/v4/search 504 Timeout Errors"
type: "runbook"
...
# Story-API /api/v4/search 504 Timeout Errors

## Summary

The /api/v4/search endpoint experienced repeated 504 Request Timeout errors in April 2026, and was later marked resolved.

## Claims

- The /api/v4/search POST endpoint returned 504 Request Timeout errors on multiple occasions. `claim:claim_1_1` `confidence:1.00`
...
- The issue was marked as resolved by blake.huynh@storyprotocol.xyz. `claim:claim_1_2` `confidence:1.00`
...
- `source_revision_id`: `srcrev_e70742940ba1d15fdaee7d6523137993`
