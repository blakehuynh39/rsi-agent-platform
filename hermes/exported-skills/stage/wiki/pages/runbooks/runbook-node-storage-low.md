...
freshness: "2024-10-04T18:57:00Z"
tags:
  - "aws"
  - "ebs"
  - "runbook"
...
- If you received an alert (≥ 80%) about not enough disk space available on a validator, chances are we need to increase disk size to all validators. `claim:claim_1_1` `confidence:1.00`
  - citation: [Notion source](https://www.notion.so/PD-Node-storage-low-115051299a5480fdaf3adeeffc86f4b4) `source_document_id=srcdoc_129d1870f801b7984496e9f54aa7680d` `source_revision_id=srcrev_e1f26abb347b3356793bd442eddf2e71` `chunk_id=srcchunk_4c28579df1e61ef3b2f250fed22d70c4` `native_locator=https://www.notion.so/PD-Node-storage-low-115051299a5480fdaf3adeeffc86f4b4` `source_timestamp=2024-10-04T18:57:00Z`
