...
Log of errors and spike protection events for the story-api service, as reported in the monitoring Slack channel #C07K3J4JTH6.

## Claims

- On 2024-10-29, an engineer reported that many endpoints seemed to be working but needed to access Sentry for exact request details. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 2025-12-22 at 10:50:56 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 2025-12-22 at 11:40:07 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 2025-12-23 at 11:51:02 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 2025-12-23 at 12:30:08 UTC. `claim:claim_1_5` `confidence:1.00`
...
- On 2026-01-13, POST /hub/users/notifications failed with 500: Failed to list notifications. `claim:claim_1_6` `confidence:1.00`
...
- On 2026-01-13, POST /api/v3/*any failed with 500: Internal Server Error. `claim:claim_1_7` `confidence:1.00`
...
- On 2026-01-13, POST /api/v4/search failed with 500: Internal Server Error. `claim:claim_1_8` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 2026-01-28 at 12:58:51 UTC. `claim:claim_1_9` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 2026-01-28 at 13:30:11 UTC. `claim:claim_1_10` `confidence:1.00`
...
- On 2026-02-25, POST /api/v4/assets/edges failed with 500: Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- On 2026-02-25, POST /api/v4/licenses/tokens failed with 500: Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- On 2026-02-25, POST /api/v4/transactions failed with 500: Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- On 2026-02-25, POST /api/v4/disputes failed with 500: Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- On 2026-02-25, GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error. `claim:claim_1_15` `confidence:1.00`
...
- On 2026-02-25, an error occurred during search: 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input'. `claim:claim_1_16` `confidence:1.00`
...
- On 2026-02-25, an error occurred during search: 'failed to perform search: all retries failed: received status code 500'. `claim:claim_1_17` `confidence:1.00`
...
- On 2026-02-26, a fatal error occurred: #28P01 password authentication failed for user "postgres". `claim:claim_1_18` `confidence:1.00`
...
- On 2026-02-27, an error occurred: failed to create IP asset: ERROR #23502 null value in column "blacklisted" of relation "ip_assets" violates not-null constraint. `claim:claim_1_19` `confidence:1.00`
...
- On 2026-02-27, an error occurred: failed to create entity: ERROR #23502 null value in column "id" of relation "users" violates not-null constraint. `claim:claim_1_20` `confidence:1.00`
...
- On 2026-03-03, POST /api/v4/collections failed with 500: Internal Server Error. `claim:claim_1_21` `confidence:1.00`
...
- On 2026-03-08, an error occurred: strconv.ParseInt: parsing "99999999999999999999999": value out of range. `claim:claim_1_22` `confidence:1.00`
...
- On 2026-03-08, GET /api/v4/disputes/:disputeId failed with 500: Internal server error. `claim:claim_1_23` `confidence:1.00`
...
- What are the root causes of these repeated 500 errors and spike protection activations?

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_6132bde7728b1c79df608d63c11d20b0`
