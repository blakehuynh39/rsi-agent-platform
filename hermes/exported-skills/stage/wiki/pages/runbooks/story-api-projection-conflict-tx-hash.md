---
title: "story-api projection conflict: refusing to overwrite an existing tx_hash"
type: "runbook"
...
# story-api projection conflict: refusing to overwrite an existing tx_hash

## Summary

An incident where story-api's projection layer encountered a conflict when trying to overwrite an existing tx_hash. The issue was reported via Sentry and later marked as resolved by Blake Huynh.

## Claims

- The story-api experienced a projection conflict, refusing to overwrite an existing tx_hash. `claim:claim_1_1` `confidence:1.00`
...
- Blake Huynh marked the STORY-API-EV Sentry issue as resolved. `claim:claim_1_2` `confidence:1.00`
...
- `source_revision_id`: `srcrev_0313ef5ff33949ce5eb44bcb9d1ee553`
