...
type: "runbook"
slug: "runbooks/story-api-submitter-tick-failure"
...
The story-api service experienced a submitter tick failure, which automatically retried. The associated Sentry issue STORY-API-EQ was resolved by blake.huynh@storyprotocol.xyz.

## Claims

- The story-api submitter logged tick failures: "[story-api] submitter tick failed; sleeping before retry" `claim:claim_1_1` `confidence:1.00`
...
- Sentry issue STORY-API-EQ was marked as resolved by blake.huynh@storyprotocol.xyz `claim:claim_1_2` `confidence:1.00`
...
- What caused the submitter tick failure?

## Sources

- `source_document_id`: `srcdoc_fdd871f83242f5b35cb041baff90bb62`
- `source_revision_id`: `srcrev_64fa7baa5fa380f80d53c23dac443e7f`
