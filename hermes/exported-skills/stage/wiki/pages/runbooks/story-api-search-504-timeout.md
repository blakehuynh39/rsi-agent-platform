---
title: "Story API Search 504 Timeout"
type: "runbook"
...
# Story API Search 504 Timeout

## Summary

Story API search endpoint experienced 504 timeouts on multiple occasions. Issue STORY-API-E9 was resolved but timeouts recurred.

## Claims

- First observed timeout of story-api POST /api/v4/search with 504. `claim:claim_1_1` `confidence:1.00`
...
- Blake Huynh resolved Sentry issue STORY-API-E9. `claim:claim_1_2` `confidence:1.00`
...
- Timeouts recurred after resolution (first recurrence). `claim:claim_1_3` `confidence:1.00`
...
- Second recurrence of timeout. `claim:claim_1_4` `confidence:1.00`
...
- Third recurrence of timeout. `claim:claim_1_5` `confidence:1.00`
...
- Why does the 504 timeout keep recurring after resolution?

## Sources

- `source_document_id`: `srcdoc_3731dd88fe850cf663f5518d6a9b0918`
- `source_revision_id`: `srcrev_6a7110e1a26d276d35710a9789a66307`
