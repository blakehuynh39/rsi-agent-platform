---
title: "Story API Search Endpoint 504 Timeout"
type: "runbook"
...
# Story API Search Endpoint 504 Timeout

## Summary

The /api/v4/search POST endpoint in story-api has experienced intermittent 504 Request Timeout errors. The issue was marked resolved on 2026-04-17 but reoccurred later.

## Claims

- On 2026-04-04T04:31:21Z, story-api POST /api/v4/search failed with 504: Request timeout `claim:claim_1_1` `confidence:1.00`
...
- Blake Huynh marked Sentry issue STORY-API-E9 as resolved `claim:claim_1_2` `confidence:1.00`
...
- On 2026-04-24T13:26:17Z, story-api POST /api/v4/search failed again with 504: Request timeout `claim:claim_1_3` `confidence:1.00`
...
- On 2026-04-26T03:00:17Z, story-api POST /api/v4/search failed again with 504: Request timeout `claim:claim_1_4` `confidence:1.00`
...
- On 2026-04-27T14:05:47Z, story-api POST /api/v4/search failed again with 504: Request timeout `claim:claim_1_5` `confidence:1.00`
...
- What is the root cause of the intermittent 504 timeout on /api/v4/search?

## Sources

- `source_document_id`: `srcdoc_3731dd88fe850cf663f5518d6a9b0918`
- `source_revision_id`: `srcrev_447b7c3e695918a211a9bb7a75a64e84`
