---
title: "CORS Issue on Staging Portal"
type: "runbook"
...
# CORS Issue on Staging Portal

## Summary

Resolving CORS error when accessing the staging portal (https://portal-v2-staging.vercel.app/) by updating the backend endpoint from deprecated edge.stg to staging-api.storyprotocol.net.

## Claims

- CORS error was reported for the staging portal at https://portal-v2-staging.vercel.app/. `claim:claim_1_1` `confidence:1.00`
...
- The API endpoint causing the CORS issue was https://edge.stg.storyprotocol.net/hub/. `claim:claim_1_2` `confidence:1.00`
...
- The staging environment (aeneid) was working fine, while production (mainnet) had the CORS issue. `claim:claim_1_3` `confidence:1.00`
...
- The portal password is 'programmableOG'. `claim:claim_1_4` `confidence:1.00`
  - citation: `source_document_id=srcdoc_fc51226808b70b0ea393fdaceb83c658` `source_revision_id=srcrev_3d67e52c423e8c409854ed6f282e8b59` `chunk_id=srcchunk_b878407ae207e2d1b8c91c51ecc4c408` `native_locator=slack:C0547N89JUB:1769130253.706209:1769218333.198919` `source_timestamp=2026-01-24T01:36:19Z`
- The endpoint was hitting the hub API for user profile data, e.g., https://edge.stg.storyprotocol.net/hub/users/v1/profile. `claim:claim_1_5` `confidence:1.00`
...
- The edge.stg endpoint was identified as very outdated. `claim:claim_1_6` `confidence:1.00`
...
- The recommended staging API endpoint is https://staging-api.storyprotocol.net. `claim:claim_1_7` `confidence:1.00`
...
- After switching to staging-api.storyprotocol.net, a 401 Unauthorized error occurred initially. `claim:claim_1_8` `confidence:1.00`
...
- The issue was resolved after updating a dynamic environment variable. `claim:claim_1_9` `confidence:1.00`
...
- `source_revision_id`: `srcrev_641c23d2e98acb1aeaa1e81c0a35eeb4`
