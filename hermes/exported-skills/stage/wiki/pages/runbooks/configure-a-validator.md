...
source_revision_ids:
  - "srcrev_9d0b81793e5ea17b70b25070c1c0fff9"
conflict_state: "none"
---
...
A guide for setting up a validator node, including prerequisites and step-by-step instructions (currently incomplete).
...
- The step-by-step guide is incomplete (contains empty blocks and 'TBA').

## Sources

- `source_document_id`: `srcdoc_24ba1b92e464768eac9e56cee8d01965`
- `source_revision_id`: `srcrev_9d0b81793e5ea17b70b25070c1c0fff9`
- `source_url`: [Notion source](https://www.notion.so/Configure-a-Validator-76f876d764c04d919cd37a23581db78d)
