...
Operational incidents and errors for the story-api service, including spike protection activations and various 500 errors.

## Claims

- Spike protection was activated for the project story-api for spans on 12/22/2025, 10:50:56 UTC. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 12/22/2025, 11:40:07 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 12/23/2025, 11:51:02 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 12/23/2025, 12:30:08 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 01/28/2026, 12:58:51 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 01/28/2026, 13:30:11 UTC. `claim:claim_1_6` `confidence:1.00`
...
- An error with stack trace: 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input'. `claim:claim_1_15` `confidence:1.00`
...
- An error with stack trace: 'failed to perform search: all retries failed: received status code 500'. `claim:claim_1_16` `confidence:1.00`
...
- A FATAL error: #28P01 password authentication failed for user "postgres". `claim:claim_1_17` `confidence:1.00`
...
- An error: 'failed to create IP asset: ERROR #23502 null value in column "blacklisted" of relation "ip_assets" violates not-null constraint'. `claim:claim_1_18` `confidence:1.00`
...
- An error: 'failed to create entity: ERROR #23502 null value in column "id" of relation "users" violates not-null constraint'. `claim:claim_1_19` `confidence:1.00`
...
- An error: 'strconv.ParseInt: parsing "99999999999999999999999": value out of range'. `claim:claim_1_21` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal server error (separate incident). `claim:claim_1_22` `confidence:1.00`
...
- `source_revision_id`: `srcrev_63c2bedfe39075f7674fd1c75d32d9f4`
