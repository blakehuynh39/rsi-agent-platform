...
Log of operational incidents for story-api reported in the #story-api Slack channel, including spike protection events and numerous HTTP 500 errors across multiple endpoints.

## Claims

- Initial check of endpoints was performed. `claim:claim_1_1` `confidence:1.00`
...
- Many endpoints appeared working, but Sentry analysis was needed for the issue. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 12/22/2025 at 10:50:56 UTC. `claim:claim_1_3` `confidence:1.00`
  - citation: `source_document_id=srcdoc_5d3459afcedd0f5ec46a635b1efb5eea` `source_revision_id=srcrev_df0e1895da131c758b246bd20586870f` `chunk_id=srcchunk_9cbdbd286653a844530f2a99d53a318c` `native_locator=slack:C07K3J4JTH6:1730234655.927619:1730234655.927619` `source_timestamp=2025-12-22T10:50:57Z`
- Spike protection was deactivated for story-api spans on 12/22/2025 at 11:40:07 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 12/23/2025 at 11:51:02 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 12/23/2025 at 12:30:08 UTC. `claim:claim_1_6` `confidence:1.00`
...
- POST /hub/users/notifications failed with 500: Failed to list notifications. `claim:claim_1_7` `confidence:1.00`
...
- POST /api/v3/*any failed with 500: Internal Server Error. `claim:claim_1_8` `confidence:1.00`
...
- POST /api/v4/search failed with 500: Internal Server Error. `claim:claim_1_9` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 01/28/2026 at 12:58:51 UTC. `claim:claim_1_10` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 01/28/2026 at 13:30:11 UTC. `claim:claim_1_11` `confidence:1.00`
...
- POST /api/v4/assets/edges failed with 500: Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- POST /api/v4/licenses/tokens failed with 500: Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- POST /api/v4/transactions failed with 500: Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- POST /api/v4/disputes failed with 500: Internal Server Error. `claim:claim_1_15` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error. `claim:claim_1_16` `confidence:1.00`
...
- Search failure with error: failed to unmarshal response: unexpected end of JSON input (all retries failed). `claim:claim_1_17` `confidence:1.00`
...
- Search failure with error: received status code 500 (all retries failed). `claim:claim_1_18` `confidence:1.00`
...
- Database authentication failure: FATAL #28P01 password authentication failed for user "postgres". `claim:claim_1_19` `confidence:1.00`
...
- Failed to create IP asset due to null value in column "blacklisted" violating not-null constraint (ERROR #23502). `claim:claim_1_20` `confidence:1.00`
...
- Failed to create entity due to null value in column "id" of relation "users" violating not-null constraint (ERROR #23502). `claim:claim_1_21` `confidence:1.00`
...
- POST /api/v4/collections failed with 500: Internal Server Error. `claim:claim_1_22` `confidence:1.00`
...
- Parsing error: strconv.ParseInt: parsing "99999999999999999999999": value out of range. `claim:claim_1_23` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal server error. `claim:claim_1_24` `confidence:1.00`
...
- What is the root cause of recurring spike protection activations and widespread 500 errors in story-api?

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_958a11eb7258c3aa1ed6eaa3a854e48b`
