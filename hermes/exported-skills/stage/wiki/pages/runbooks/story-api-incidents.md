...
A log of recent incidents affecting the story-api service, including spike protection events, 500 errors on various endpoints, and database errors.

## Claims

- A developer noted that for many of the endpoints related, they seem to be working, but they will need to access sentry to see the exact request that created the issue. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 12/22/2025 at 10:50:56 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 12/22/2025 at 11:40:07 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 12/23/2025 at 11:51:02 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 12/23/2025 at 12:30:08 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection was activated for story-api for spans on 01/28/2026 at 12:58:51 UTC. `claim:claim_1_6` `confidence:1.00`
...
- Spike protection was deactivated for story-api for spans on 01/28/2026 at 13:30:11 UTC. `claim:claim_1_7` `confidence:1.00`
...
- story-api experienced a 500 error on POST /hub/users/notifications: "Failed to list notifications". `claim:claim_1_8` `confidence:1.00`
...
- story-api experienced a 500 error on POST /api/v3/*any: "Internal Server Error". `claim:claim_1_9` `confidence:1.00`
...
- story-api experienced a 500 error on POST /api/v4/search: "Internal Server Error". `claim:claim_1_10` `confidence:1.00`
...
- story-api experienced a 500 error on POST /api/v4/assets/edges: "Internal Server Error". `claim:claim_1_11` `confidence:1.00`
...
- story-api experienced a 500 error on POST /api/v4/licenses/tokens: "Internal Server Error". `claim:claim_1_12` `confidence:1.00`
...
- story-api experienced a 500 error on POST /api/v4/transactions: "Internal Server Error". `claim:claim_1_13` `confidence:1.00`
...
- story-api experienced a 500 error on POST /api/v4/disputes: "Internal Server Error". `claim:claim_1_14` `confidence:1.00`
...
- story-api experienced a 500 error on GET /api/v4/disputes/:disputeId: "Internal Server Error". `claim:claim_1_15` `confidence:1.00`
...
- story-api encountered an error: "failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input". `claim:claim_1_16` `confidence:1.00`
...
- story-api encountered an error: "failed to perform search: all retries failed: received status code 500". `claim:claim_1_17` `confidence:1.00`
...
- story-api encountered a fatal database error: "FATAL #28P01 password authentication failed for user "postgres"". `claim:claim_1_18` `confidence:1.00`
...
- story-api encountered a database error: "failed to create IP asset: ERROR #23502 null value in column "blacklisted" of relation "ip_assets" violates not-null constraint". `claim:claim_1_19` `confidence:1.00`
...
- story-api encountered a database error: "failed to create entity: ERROR #23502 null value in column "id" of relation "users" violates not-null constraint". `claim:claim_1_20` `confidence:1.00`
...
- story-api experienced a 500 error on POST /api/v4/collections: "Internal Server Error". `claim:claim_1_21` `confidence:1.00`
...
- story-api encountered a parsing error: "strconv.ParseInt: parsing "99999999999999999999999": value out of range". `claim:claim_1_22` `confidence:1.00`
...
- story-api experienced a 500 error on GET /api/v4/disputes/:disputeId: "Internal server error". `claim:claim_1_23` `confidence:1.00`
...
- Root cause of the 500 Internal Server Errors on multiple endpoints is not yet determined.
- The spike protection triggers may be linked to the errors, but investigation is needed.

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_04981584077c67e4a38f1e930c6385a5`
