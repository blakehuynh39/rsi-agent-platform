...
story-api is a microservice that experienced multiple 500 Internal Server Errors and spike protection events between late 2025 and early 2026.
...
- On 2026-01-12, POST /hub/users/notifications failed with 500 Internal Server Error. `claim:claim_1_5` `confidence:1.00`
...
- On 2026-01-12, POST /api/v3/*any failed with 500 Internal Server Error. `claim:claim_1_6` `confidence:1.00`
...
- On 2026-01-12, POST /api/v4/search failed with 500 Internal Server Error. `claim:claim_1_7` `confidence:1.00`
...
- On 2026-02-24, POST /api/v4/assets/edges failed with 500 Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- On 2026-02-24, POST /api/v4/licenses/tokens failed with 500 Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- On 2026-02-24, POST /api/v4/transactions failed with 500 Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- On 2026-02-24, POST /api/v4/disputes failed with 500 Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- On 2026-02-24, GET /api/v4/disputes/:disputeId failed with 500 Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- On 2026-02-24, search failed due to 'unexpected end of JSON input' after all retries. `claim:claim_1_15` `confidence:1.00`
...
- On 2026-02-24, search failed with all retries returning status code 500. `claim:claim_1_16` `confidence:1.00`
...
- On 2026-02-25, a fatal password authentication failure for user 'postgres' occurred. `claim:claim_1_17` `confidence:1.00`
...
- On 2026-02-26, IP asset creation failed due to null value in non-nullable column 'blacklisted'. `claim:claim_1_18` `confidence:1.00`
...
- On 2026-02-26, entity creation failed due to null value in non-nullable column 'id' of users relation. `claim:claim_1_19` `confidence:1.00`
...
- On 2026-03-02, POST /api/v4/collections failed with 500 Internal Server Error. `claim:claim_1_20` `confidence:1.00`
...
- On 2026-03-07, a ParseInt error occurred for value '99999999999999999999999' which is out of range. `claim:claim_1_21` `confidence:1.00`
...
- On 2026-03-07, GET /api/v4/disputes/:disputeId failed again with 500 Internal Server Error. `claim:claim_1_22` `confidence:1.00`
...
- `source_revision_id`: `srcrev_cca91c1709cd74ccf0e34cf673a8f4be`
