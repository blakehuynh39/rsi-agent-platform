...
Monitoring and incident log for the story-api project, capturing spike protection events, 500 error patterns, and database issues.

## Claims

- On 2025-10-29, an engineer noted that many endpoints seemed to be working, but Sentry access was needed to identify the exact failing request. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2025-12-22 at 10:50:56 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2025-12-22 at 11:40:07 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2025-12-23 at 11:51:02 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2025-12-23 at 12:30:08 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2026-01-28 at 12:58:51 UTC. `claim:claim_1_6` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2026-01-28 at 13:30:11 UTC. `claim:claim_1_7` `confidence:1.00`
...
- On 2026-01-13 at 15:40 UTC, POST /hub/users/notifications failed with 500: Failed to list notifications. `claim:claim_1_8` `confidence:1.00`
...
- On 2026-01-13 at 15:52 UTC, POST /api/v3/*any failed with 500: Internal Server Error. `claim:claim_1_9` `confidence:1.00`
...
- On 2026-01-13 at 18:42 UTC, POST /api/v4/search failed with 500: Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- On 2026-02-25 at 00:22 UTC, POST /api/v4/assets/edges failed with 500: Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- On 2026-02-25 at 00:22 UTC, POST /api/v4/licenses/tokens failed with 500: Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- On 2026-02-25 at 00:22 UTC, POST /api/v4/transactions failed with 500: Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- On 2026-02-25 at 00:22 UTC, POST /api/v4/disputes failed with 500: Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- On 2026-02-25 at 00:30 UTC, GET /api/v4/disputes/:disputeId failed with 500: Internal Server Error. `claim:claim_1_15` `confidence:1.00`
...
- On 2026-02-25 at 01:21 UTC, a search error occurred: 'failed to perform search: all retries failed: failed to unmarshal response: unexpected end of JSON input'. `claim:claim_1_16` `confidence:1.00`
...
- On 2026-02-25 at 01:37 UTC, a search error occurred: 'failed to perform search: all retries failed: received status code 500'. `claim:claim_1_17` `confidence:1.00`
...
- On 2026-02-26 at 01:17 UTC, a FATAL database error occurred: 'password authentication failed for user "postgres"' (SQLSTATE 28P01). `claim:claim_1_18` `confidence:1.00`
...
- On 2026-02-27 at 01:27 UTC, an IP asset creation failed due to null value in column 'blacklisted' of relation 'ip_assets' (SQLSTATE 23502 not-null constraint). `claim:claim_1_19` `confidence:1.00`
...
- On 2026-02-27 at 04:59 UTC, a user entity creation failed due to null value in column 'id' of relation 'users' (SQLSTATE 23502 not-null constraint). `claim:claim_1_20` `confidence:1.00`
...
- On 2026-03-03 at 01:51 UTC, POST /api/v4/collections failed with 500: Internal Server Error. `claim:claim_1_21` `confidence:1.00`
...
- On 2026-03-08 at 14:02 UTC, a parsing error occurred: 'strconv.ParseInt: parsing "99999999999999999999999": value out of range'. `claim:claim_1_22` `confidence:1.00`
...
- On 2026-03-08 at 14:02 UTC, GET /api/v4/disputes/:disputeId failed with 500: Internal server error. `claim:claim_1_23` `confidence:1.00`
...
- Are the null constraint violations due to missing application-layer validations or data pipeline issues?
- How often does the search endpoint produce JSON unmarshaling errors?
- Is the database authentication failure a persistent misconfiguration or an isolated incident?
- What is the source of the out-of-range integer value causing ParseInt failures?
- What is the underlying cause of the recurring 500 Internal Server Errors across multiple endpoints?
- What triggers spike protection on story-api spans and what are the root causes of traffic spikes?

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_111f7264e35235cd217e36eb8e12060e`
