...
Aggregated Slack alerts for the story-api project, including spike protection events and internal server errors on various endpoints.

## Claims

- Spike protection activated for story-api spans on 2025-12-22 at 10:50:56 UTC. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2025-12-22 at 11:40:07 UTC. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2025-12-23 at 11:51:02 UTC. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2025-12-23 at 12:30:08 UTC. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection activated for story-api spans on 2026-01-28 at 12:58:51 UTC. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection deactivated for story-api spans on 2026-01-28 at 13:30:11 UTC. `claim:claim_1_6` `confidence:1.00`
...
- Endpoint POST /hub/users/notifications failed with HTTP 500: Failed to list notifications. `claim:claim_1_7` `confidence:1.00`
...
- Endpoint POST /api/v3/*any failed with HTTP 500: Internal Server Error. `claim:claim_1_8` `confidence:1.00`
...
- Endpoint POST /api/v4/search failed with HTTP 500: Internal Server Error. `claim:claim_1_9` `confidence:1.00`
...
- Endpoint POST /api/v4/assets/edges failed with HTTP 500: Internal Server Error. `claim:claim_1_10` `confidence:1.00`
...
- Endpoint POST /api/v4/licenses/tokens failed with HTTP 500: Internal Server Error. `claim:claim_1_11` `confidence:1.00`
...
- Endpoint POST /api/v4/transactions failed with HTTP 500: Internal Server Error. `claim:claim_1_12` `confidence:1.00`
...
- Endpoint POST /api/v4/disputes failed with HTTP 500: Internal Server Error. `claim:claim_1_13` `confidence:1.00`
...
- Endpoint GET /api/v4/disputes/:disputeId failed with HTTP 500: Internal Server Error. `claim:claim_1_14` `confidence:1.00`
...
- Search error: all retries failed due to unmarshaling response: unexpected end of JSON input. `claim:claim_1_15` `confidence:1.00`
...
- Search error: all retries failed with received status code 500. `claim:claim_1_16` `confidence:1.00`
...
- Fatal database error: password authentication failed for user "postgres". `claim:claim_1_17` `confidence:1.00`
...
- Endpoint POST /api/v4/collections failed with HTTP 500: Internal Server Error. `claim:claim_1_20` `confidence:1.00`
...
- Parsing error: value "99999999999999999999999" out of range for ParseInt. `claim:claim_1_21` `confidence:1.00`
...
- Endpoint GET /api/v4/disputes/:disputeId failed with HTTP 500: Internal server error (another occurrence). `claim:claim_1_22` `confidence:1.00`
...
- `source_revision_id`: `srcrev_752d8dfbdf5c92a161ade263cba6018a`
