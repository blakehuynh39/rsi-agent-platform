...
Compilation of spike protection actions and API errors for the story-api project observed in Slack channel C07K3J4JTH6.

## Claims

- Spike protection was activated for story-api spans on 2025-12-22T10:50:56Z. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2025-12-22T11:40:07Z. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was activated again on 2025-12-23T11:51:02Z. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was deactivated on 2025-12-23T12:30:08Z. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was activated on 2026-01-28T12:58:51Z. `claim:claim_1_5` `confidence:1.00`
...
- Spike protection was deactivated on 2026-01-28T13:30:11Z. `claim:claim_1_6` `confidence:1.00`
...
- Search operation failed with error: failed to unmarshal response: unexpected end of JSON input. `claim:claim_1_15` `confidence:1.00`
...
- Search operation failed with received status code 500. `claim:claim_1_16` `confidence:1.00`
...
- FATAL: password authentication failed for user "postgres". `claim:claim_1_17` `confidence:1.00`
...
- Failed to create IP asset due to null value in column "blacklisted" violates not-null constraint. `claim:claim_1_18` `confidence:1.00`
...
- Failed to create entity due to null value in column "id" of relation "users" violates not-null constraint. `claim:claim_1_19` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with 500: Internal server error (duplicate). `claim:claim_1_22` `confidence:1.00`
...
- Is there a deployment or configuration change correlated with these errors?
- What caused the spike protection activations?
- What is the root cause of the null constraint violations?
- Why did password authentication to postgres fail?

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_86a27ca18a7c7cca9119df88da19cf8d`
