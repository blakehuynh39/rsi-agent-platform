...
Operational incidents and errors reported for the story-api service.

## Claims

- On 2024-10-29T20:36:39Z, many story-api endpoints appeared to be working, but investigation via Sentry was planned for a specific issue. `claim:claim_1_1` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 2025-12-22T10:50:56Z. `claim:claim_1_2` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2025-12-22T11:40:07Z. `claim:claim_1_3` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 2025-12-23T11:51:02Z. `claim:claim_1_4` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2025-12-23T12:30:08Z. `claim:claim_1_5` `confidence:1.00`
...
- POST /hub/users/notifications failed with HTTP 500 and message 'Failed to list notifications' on 2026-01-13T21:20:21Z. `claim:claim_1_6` `confidence:1.00`
...
- POST /api/v3/*any failed with HTTP 500 'Internal Server Error' on 2026-01-13T21:32:00Z. `claim:claim_1_7` `confidence:1.00`
...
- POST /api/v4/search failed with HTTP 500 'Internal Server Error' on 2026-01-13T23:22:41Z. `claim:claim_1_8` `confidence:1.00`
...
- Spike protection was activated for story-api spans on 2026-01-28T12:58:51Z. `claim:claim_1_9` `confidence:1.00`
...
- Spike protection was deactivated for story-api spans on 2026-01-28T13:30:11Z. `claim:claim_1_10` `confidence:1.00`
...
- POST /api/v4/assets/edges failed with HTTP 500 'Internal Server Error' on 2026-02-13T00:35:41Z. `claim:claim_1_11` `confidence:1.00`
...
- POST /api/v4/licenses/tokens failed with HTTP 500 'Internal Server Error' on 2026-02-13T00:35:41Z. `claim:claim_1_12` `confidence:1.00`
...
- POST /api/v4/transactions failed with HTTP 500 'Internal Server Error' on 2026-02-13T00:35:41Z. `claim:claim_1_13` `confidence:1.00`
...
- POST /api/v4/disputes failed with HTTP 500 'Internal Server Error' on 2026-02-13T00:35:42Z. `claim:claim_1_14` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with HTTP 500 'Internal Server Error' on 2026-02-13T00:50:11Z. `claim:claim_1_15` `confidence:1.00`
...
- Search operation failed with 'failed to unmarshal response: unexpected end of JSON input' on 2026-02-13T01:34:20Z. `claim:claim_1_16` `confidence:1.00`
...
- Search operation failed with 'received status code 500' on 2026-02-13T01:50:27Z. `claim:claim_1_17` `confidence:1.00`
...
- Database password authentication failed for user 'postgres' (FATAL #28P01) on 2026-02-14T04:23:39Z. `claim:claim_1_18` `confidence:1.00`
...
- IP asset creation failed with not-null constraint violation on column 'blacklisted' (relation 'ip_assets', error #23502) on 2026-02-15T04:20:54Z. `claim:claim_1_19` `confidence:1.00`
...
- User entity creation failed with not-null constraint violation on column 'id' (relation 'users', error #23502) on 2026-02-15T07:52:20Z. `claim:claim_1_20` `confidence:1.00`
...
- POST /api/v4/collections failed with HTTP 500 'Internal Server Error' on 2026-02-19T06:44:40Z. `claim:claim_1_21` `confidence:1.00`
...
- ParseInt overflow error while parsing '99999999999999999999999' on 2026-02-25T06:42:26Z. `claim:claim_1_22` `confidence:1.00`
...
- GET /api/v4/disputes/:disputeId failed with HTTP 500 'Internal server error' on 2026-02-25T06:42:47Z. `claim:claim_1_23` `confidence:1.00`
...
- Are there missing database defaults for ip_assets.blacklisted and users.id columns?
- What is the root cause of the frequent 500 errors across multiple endpoints?
- What request caused the parse failure with out-of-range integer '99999999999999999999999'?
- What triggers spike protection for story-api?
- Why did password authentication fail for user 'postgres'?

## Sources

- `source_document_id`: `srcdoc_5d3459afcedd0f5ec46a635b1efb5eea`
- `source_revision_id`: `srcrev_1545c2fdeccfc3b22f86a4f6c52bf9cb`
