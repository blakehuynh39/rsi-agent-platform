...
Migration of the Story Protocol devnet from GCP to AWS. A new provisioning repository was created, and access is being configured for team members.

## Claims

- Yao created a new repository storyprotocol/story-devnet-aws for devnet AWS provisioning, based on previous internal-devnet code. `claim:claim_1_1` `confidence:1.00`
...
- Updated devnet domains: RPC at devnet0.storyrpc.io and Explorer at devnet0.storyscan.io. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- The genesis generation script `update-genesis-hash.sh` is a helper script and does not carry any special context requiring attention for the migration. `claim:claim_1_3` `confidence:1.00`
...
- Yao was granted SystemAdministrator access to the AWS devnet account initially, and later given maintain role on the story-devnet-aws GitHub repository. `claim:claim_1_4` `confidence:1.00`
...
- Yao requested additional AWS permissions to launch instances for full sync testing, but encountered AccessDeniedException when trying to start SSM sessions using either the SystemAdministrator or AWS-QA-Devnet-Access roles. `claim:claim_1_5` `confidence:1.00`
...
- Yao still needs instance launch / SSM permissions to proceed with full sync testing; pending resolution.

## Sources

- `source_document_id`: `srcdoc_21912519959226e3397c0d1ec8c0dd39`
- `source_revision_id`: `srcrev_b0cbaf15ca2fd0756f3f7cd7f5a8c5ff`
