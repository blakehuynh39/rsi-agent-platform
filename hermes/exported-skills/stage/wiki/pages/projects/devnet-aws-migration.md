...
Migration of devnet infrastructure from Google Cloud Platform (GCP) to Amazon Web Services (AWS). Covers the new provisioning repository, genesis scripts, domain changes, and access configuration.

## Claims

- Yao created the repository story-devnet-aws for the devnet migration from GCP to AWS, based on previous internal-devnet provisioning code. `claim:claim_1_1` `confidence:1.00`
...
- The genesis generation script update-genesis-hash.sh is a helper script and does not require special context. `claim:claim_1_2` `confidence:1.00`
...
- AWS Server Access Guide is available at https://www.notion.so/storyprotocol/AWS-Server-Access-Guide-2ee051299a5480d998e2d3bb23abd3ea `claim:claim_1_3` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- Updated devnet0 domains: RPC at devnet0.storyrpc.io, Explorer at devnet0.storyscan.io `claim:claim_1_4` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- Yao was initially granted systemAdmin access to the story-devnet account. `claim:claim_1_5` `confidence:1.00`
...
- Yao requested additional permissions to launch instances for full sync testing. `claim:claim_1_6` `confidence:1.00`
...
- Lucas granted Yao maintain role on the story-devnet-aws repository. `claim:claim_1_7` `confidence:1.00`
...
- A PR for Yao's AWS access was created: https://github.com/storyprotocol/AWS-Organization/pull/8 `claim:claim_1_8` `confidence:1.00`
...
- Yao encountered SSM session start AccessDenied errors when trying to start sessions to instances, even with two different roles (SystemAdministrator and AWS-QA-Devnet-Access). `claim:claim_1_9` `confidence:1.00`
...
- Access resolution is in progress; a quick test with Lucas is planned. `claim:claim_1_10` `confidence:1.00`
...
- Is Yao's SSM access issue fully resolved? What permissions are still needed?

## Sources

- `source_document_id`: `srcdoc_21912519959226e3397c0d1ec8c0dd39`
- `source_revision_id`: `srcrev_601e41e9ed3b697e900e25209a80b017`
