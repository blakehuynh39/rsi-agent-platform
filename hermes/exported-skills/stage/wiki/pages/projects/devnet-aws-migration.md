...
Migration of the Story Protocol devnet from GCP to AWS using the story-devnet-aws repository. Involves setting up new domains and granting AWS permissions to team members.
...
- Updated domains for the migrated devnet: RPC at devnet0.storyrpc.io, Explorer at devnet0.storyscan.io. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- The genesis generation script `update-genesis-hash.sh` exists and is a helper script that requires no special context. `claim:claim_1_3` `confidence:1.00`
...
- Yao was initially granted systemAdmin access to the AWS devnet account. `claim:claim_1_4` `confidence:1.00`
...
- Yao requested additional permissions to launch EC2 instances for full sync testing and to manage GitHub Actions in the repository. `claim:claim_1_5` `confidence:1.00`
...
- Yao was given maintain role on the GitHub repository story-devnet-aws. `claim:claim_1_6` `confidence:1.00`
...
- SSM start-session access was initially denied for both SystemAdministrator and AWS-QA-Devnet-Access roles. `claim:claim_1_7` `confidence:1.00`
...
- Permissions were eventually resolved after updates to AWS IAM policies. `claim:claim_1_8` `confidence:1.00`
...
- AWS server access guide is available at https://www.notion.so/storyprotocol/AWS-Server-Access-Guide-2ee051299a5480d998e2d3bb23abd3ea `claim:claim_1_9` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`

## Open Questions

- Are there remaining permission issues for Yao to launch EC2 instances?
- Is the devnet fully operational on AWS after migration?

## Related Pages

- `aws-server-access-guide-notion`
- `story-devnet-aws-github-repo`

## Sources

- `source_document_id`: `srcdoc_21912519959226e3397c0d1ec8c0dd39`
- `source_revision_id`: `srcrev_0d3c3c7e15d7ea429d9ab0ba20abef4d`
