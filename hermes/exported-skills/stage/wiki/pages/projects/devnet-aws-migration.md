...
Migration of Story Protocol devnet from GCP to AWS, including provisioning infrastructure, genesis configuration, and managing access permissions.

## Claims

- A new repository storyprotocol/story-devnet-aws was created based on previous internal-devnet provisioning code. `claim:claim_1_1` `confidence:1.00`
...
- AWS Server Access Guide is available at a Notion page. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- Updated devnet domains: RPC at devnet0.storyrpc.io and Explorer at devnet0.storyscan.io. `claim:claim_1_3` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- Genesis generation scripts include update-genesis-hash.sh and are helper scripts with no special context required. `claim:claim_1_4` `confidence:1.00`
...
- Yao (yao.wang@piplabs.xyz) was granted systemAdmin access to the devnet account. `claim:claim_1_5` `confidence:1.00`
...
- Yao was given maintain role in the story-devnet-aws repository. `claim:claim_1_7` `confidence:1.00`
...
- A PR (storyprotocol/AWS-Organization/pull/8) for Yao's access was created and merged. `claim:claim_1_8` `confidence:1.00`
...
- Permissions for Yao were defined in story-dev-ou/main.tf with a policy allowing certain actions. `claim:claim_1_9` `confidence:1.00`
...
- A Terraform workflow or security scan failure occurred during the access change merge but was resolved. `claim:claim_1_10` `confidence:1.00`
  ...
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_2f4c634ece1214f473aae27110313f7d` `chunk_id=srcchunk_fec44376ee4a1fccaa26319e9b3c6214` `native_locator=slack:C0547N89JUB:1768945631.194489:1769706890.638689` `source_timestamp=2026-01-29T17:14:50Z`
- Despite permissions, Yao encountered AccessDeniedException when attempting to start an SSM session using both SystemAdministrator and devnet roles. `claim:claim_1_11` `confidence:1.00`
...
- Lucas will run a quick test with Yao to resolve the lingering access issue. `claim:claim_1_12` `confidence:1.00`
...
- What additional IAM policies are required to allow ssm:StartSession for the devnet migration workflow?
- Why does Yao still lack permissions to launch instances or start SSM sessions despite being given systemAdmin and maintain roles?

## Sources

- `source_document_id`: `srcdoc_21912519959226e3397c0d1ec8c0dd39`
- `source_revision_id`: `srcrev_9b5fc1bd2a4f8cffae503abba78c15e9`
