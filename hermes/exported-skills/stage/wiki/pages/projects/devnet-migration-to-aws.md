...
Migration of Story devnet from GCP to AWS, involving a new repository story-devnet-aws, domain updates, and access provisioning.
...
- The repository was based on previous internal-devnet provisioning code. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- Updated devnet domains: RPC at `devnet0.storyrpc.io`, Explorer at `devnet0.storyscan.io`. `claim:claim_1_3` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- AWS server access guide is available at `https://www.notion.so/storyprotocol/AWS-Server-Access-Guide-2ee051299a5480d998e2d3bb23abd3ea`. `claim:claim_1_4` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- The genesis generation script `update-genesis-hash.sh` was confirmed to be a helper script with no special context required for finalizing the workflow. `claim:claim_1_5` `confidence:1.00`
...
- Yao was granted systemAdmin access to the devnet AWS account. `claim:claim_1_6` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_a8df9f25874bfae9ae77b57d47fbd1a2` `chunk_id=srcchunk_c74548a12c0e0f60dd1398c519e32f5e` `native_locator=slack:C0547N89JUB:1768945631.194489:1768976762.443739` `source_timestamp=2026-01-21T06:26:02Z`
- Yao requested additional permissions to launch EC2 instances for full sync testing. `claim:claim_1_7` `confidence:1.00`
...
- Yao was given maintain role in the `story-devnet-aws` GitHub repo to access GitHub Actions. `claim:claim_1_8` `confidence:1.00`
...
- SSM access was denied for both `SystemAdministrator` and `AWS-QA-Devnet-Access` roles, preventing session start on instances. `claim:claim_1_9` `confidence:1.00`
...
- Permission adjustments were made via `https://github.com/storyprotocol/AWS-Organization/blob/0bab852b32a88f662402d060589d755bd0063e01/accounts/story-dev-ou/main.tf#L33`, but initial Terraform workflow had security scan failures. `claim:claim_1_10` `confidence:1.00`
...
- Did the proposed quick test with Chris resolve the SSM access issues?
- Is Yao now able to launch EC2 instances and start SSM sessions for full sync testing?

## Sources

- `source_document_id`: `srcdoc_21912519959226e3397c0d1ec8c0dd39`
- `source_revision_id`: `srcrev_18a91aae0f159f3c3a38c958876a5de8`
