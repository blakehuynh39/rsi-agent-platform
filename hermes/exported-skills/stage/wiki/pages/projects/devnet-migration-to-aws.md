...
Migration of Story devnet from GCP to AWS, involving a new provisioning repo, genesis scripts, account permissions, and domain updates.

## Claims

- Yao created a new repository story-devnet-aws for devnet migration from GCP to AWS. `claim:claim_1_1` `confidence:1.00`
...
- The new repository is based on previous internal-devnet provisioning code. `claim:claim_1_2` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- The genesis generation script update-genesis-hash.sh is a helper script that requires no special context. `claim:claim_1_3` `confidence:1.00`
...
- The updated devnet domains will be devnet0.storyrpc.io (RPC) and devnet0.storyscan.io (Explorer). `claim:claim_1_5` `confidence:1.00`
  - citation: `source_document_id=srcdoc_21912519959226e3397c0d1ec8c0dd39` `source_revision_id=srcrev_9b5fc1bd2a4f8cffae503abba78c15e9` `chunk_id=srcchunk_6fcd0e19afe419fd13159584446b72b9` `native_locator=slack:C0547N89JUB:1768945631.194489:1768945631.194489` `source_timestamp=2026-01-20T21:47:11Z`
- Yao completed the workflow and requested review. `claim:claim_1_6` `confidence:1.00`
...
- Yao requested additional permissions to launch instances for full sync testing. `claim:claim_1_7` `confidence:1.00`
...
- Yao was given a maintain role on the story-devnet-aws repository for GitHub Actions access. `claim:claim_1_8` `confidence:1.00`
...
- A PR (storyprotocol/AWS-Organization/pull/8) was opened and merged to grant Yao additional AWS permissions. `claim:claim_1_9` `confidence:1.00`
...
- A Terraform workflow/security scan failed during the PR merge, but the access change may have still been applied. `claim:claim_1_10` `confidence:1.00`
...
- Despite granted permissions, Yao encountered AccessDeniedException when trying to start an SSM session to an EC2 instance, using both SystemAdministrator and AWS-QA-Devnet-Access roles. `claim:claim_1_11` `confidence:1.00`
...
- Yao was asked to schedule a live test with the team to resolve the SSM permission issue. `claim:claim_1_12` `confidence:1.00`
...
- Is the SSM start-session permission fully resolved after the live test?
- What was the outcome of the Terraform workflow failure – did it affect the applied permissions?
...
- `source_revision_id`: `srcrev_393bff4edbc2495a4a06ef60ec5c32c8`
