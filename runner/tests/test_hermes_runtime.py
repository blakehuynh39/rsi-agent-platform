...
class HermesRuntimeTests(unittest.TestCase):
    ...
    def test_generated_plugin_registers_rsi_native_toolsets(self) -> None:
        ...
        self.assertIn("rsi_sentry.issue_events", by_toolset["rsi-sentry"])
        self.assertNotIn("rsi_sentry.issue_explain", by_toolset["rsi-sentry"])
        self.assertNotIn("rsi_sentry.issue_plan", by_toolset["rsi-sentry"])
