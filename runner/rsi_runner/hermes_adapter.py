...
_NATIVE_CANONICAL_PREFIXES = ("rsi_slack.", "rsi_notion.", "rsi_knowledge.", "rsi_sentry.", "rsi_kanban.", "rsi_temporal.", "rsi_aws.")
...
def _native_surface_and_operation(canonical_name: str) -> tuple[str, str]:
    ...
    if canonical_name.startswith("rsi_temporal."):
        return "temporal", canonical_name.split(".", 1)[1]
    if canonical_name.startswith("rsi_aws."):
        return "aws", canonical_name.split(".", 1)[1]
